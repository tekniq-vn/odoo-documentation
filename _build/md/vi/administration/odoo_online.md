...
![Truy cập các tùy chọn quản lý cơ sở dữ liệu](administration/odoo_online/database-manager.png)
...
![Nội dung cảnh báo hiển thị trước khi xóa cơ sở dữ liệu](administration/odoo_online/delete.png)
...
![Mời người dùng trên cơ sở dữ liệu](administration/odoo_online/invite-users.png)
