...
![image](../../../_images/interface-settings.png)

## Tên dự án

Tên dự án của bạn.

![image](../../../_images/interface-settings-projectname.png)
...
![image](../../../_images/interface-settings-collaborators.png)
...
![image](../../../_images/interface-settings-public.png)
...
![image](../../../_images/interface-settings-submodules.png)
...
![image](../../../_images/interface-settings-storage.png)
...
![image](../../../_images/interface-settings-workers.png)
...
![image](../../../_images/interface-settings-staging-branches.png)

## Kích hoạt

Hiển thị trạng thái kích hoạt của dự án. Bạn có thể thay đổi mã kích hoạt của dự án nếu cần.

![image](../../../_images/interface-settings-activation.png)
