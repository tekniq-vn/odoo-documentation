...
![Chế độ xem những mục khác nhau cần bật/nhấp để xuất dữ liệu.](../../_images/list-view-export.png)

Khi nhấp vào Xuất, một cửa sổ Xuất dữ liệu sẽ bật lên với một số tùy chọn để xuất dữ liệu:

![Tổng quan về các tùy chọn cần cân nhắc khi xuất dữ liệu trong Odoo.](../../_images/export-data-overview.png)
...
![Menu hành động được hiển thị với tùy chọn nhập bản ghi được tô sáng.](../../_images/import-button.png)
...
![Các tùy chọn định dạng được hiển thị khi tệp CVS được nhập vào Odoo.](../../_images/formatting.png)
...
![Ảnh động về chuột kéo xuống cột ID để mỗi bản ghi có một ID duy nhất.](../../_images/dragdown.gif)
...
![Menu thả xuống được mở rộng trong màn hình nhập ban đầu trên Odoo.](../../_images/field_list.png)
...
![Đang tìm kiếm trường phù hợp với cột thuế.](../../_images/field_list.png)
