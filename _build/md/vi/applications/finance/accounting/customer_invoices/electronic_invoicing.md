...
By default, the format available in the [send window](electronic_invoicing.md#e-invoicing-generation) depends on your\
customer's country.
...
![Select an EDI format for a specific customer](../../../../.gitbook/assets/customer-form.png)

### National electronic invoicing

Depending on your company's country (e.g., [Italy](applications/finance/fiscal_localizations/italy.md),[Spain](applications/finance/fiscal_localizations/spain.md), [Mexico](applications/finance/fiscal_localizations/mexico.md), etc.), you may be required to issue e-invoicing documents in\
...
![The Peppol option is checked and an e-invoicing XML file is attached to the email.](../../../../.gitbook/assets/send-window.png)
...
If not done yet, [install](applications/general/apps_modules.md#general-install) the Peppol module (`account_peppol`).
...
![Peppol module installation](../../../../.gitbook/assets/peppol-install.png)
...
![Configuration for peppol](../../../../.gitbook/assets/peppol-settings.png)
...
> <img src="../../../../.gitbook/assets/peppol-demo-mode.png" alt="Peppol demo mode selection" data-size="original">
...
![Peppol test mode parameter](../../../../.gitbook/assets/peppol-system-parameter.png) ![Peppol test mode selection](../../../../.gitbook/assets/peppol-test-mode-settings.png)

Now, you can request a verification code to be sent to you by clicking Verify phone\
number.

![phone validation request verification](../../../../.gitbook/assets/peppol-registration-verify.png)

A text message containing a code is sent to the phone number provided to finalize the verification\
process.

![phone validation](../../../../.gitbook/assets/phone-registration.png)
...
![pending application](../../../../.gitbook/assets/peppol-registration-pending.png)
...
![active application](../../../../.gitbook/assets/peppol-registration-active.png)
...
![verify contact registration](../../../../.gitbook/assets/peppol-contact-verify.png)
...
![Send peppol invoice](../../../../.gitbook/assets/peppol-send-print.png)
...
![Filter Peppol ready invoices](../../../../.gitbook/assets/peppol-ready-invoices.png)
...
![Peppol message status](../../../../.gitbook/assets/peppol-message-processing.png)
...
![Fetch invoice Peppol status](../../../../.gitbook/assets/peppol-fetch-message-status.png)
...
![peppol receive bills](../../../../.gitbook/assets/peppol-receive-bills.png)
...
![Fetch bills from Peppol](../../../../.gitbook/assets/peppol-fetch-bills.png)
