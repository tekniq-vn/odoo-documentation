...
![Select an EDI format for a specific customer](../../../../_images/customer-form.png)

### National electronic invoicing

Depending on your company's country (e.g., [Italy](../../fiscal_localizations/italy.md),[Spain](../../fiscal_localizations/spain.md), [Mexico](../../fiscal_localizations/mexico.md), etc.), you may be required to issue e-invoicing documents in\
...
![The Peppol option is checked and an e-invoicing XML file is attached to the email.](../../../../_images/send-window.png)
...
![Peppol module installation](../../../../_images/peppol-install.png)
...
![Configuration for peppol](../../../../_images/peppol-settings.png)
...
> <img src="../../../../_images/peppol-demo-mode.png" alt="Peppol demo mode selection" data-size="original">
...
![Peppol test mode parameter](../../../../_images/peppol-system-parameter.png) ![Peppol test mode selection](../../../../_images/peppol-test-mode-settings.png)

Now, you can request a verification code to be sent to you by clicking Verify phone\
number.

![phone validation request verification](../../../../_images/peppol-registration-verify.png)

A text message containing a code is sent to the phone number provided to finalize the verification\
process.

![phone validation](../../../../_images/phone-registration.png)
...
![pending application](../../../../_images/peppol-registration-pending.png)
...
![active application](../../../../_images/peppol-registration-active.png)
...
![verify contact registration](../../../../_images/peppol-contact-verify.png)
...
![Send peppol invoice](../../../../_images/peppol-send-print.png)
...
![Filter Peppol ready invoices](../../../../_images/peppol-ready-invoices.png)
...
![Peppol message status](../../../../_images/peppol-message-processing.png)
...
![Fetch invoice Peppol status](../../../../_images/peppol-fetch-message-status.png)
...
![peppol receive bills](../../../../_images/peppol-receive-bills.png)
...
![Fetch bills from Peppol](../../../../_images/peppol-fetch-bills.png)
