...
[Accounting Firms](../#fiduciaries) mode.
...
your database, or when you set up a [fiscal localization package](../../fiscal_localizations/#fiscal-localizations-packages) for your company.

<a id="taxes-list-activation"></a>

## Activate sales taxes from the list view

As part of your [fiscal localization package](../../fiscal_localizations/#fiscal-localizations-packages), most of your
...
[sales orders](../../../sales/sales/), [invoices](../customer_invoices/), product forms, etc.
...
the same tax differently according to [fiscal positions](fiscal_positions.md).
...
following documentation: [B2B (tax excluded) and B2C (tax included) pricing](B2B_B2C.md).
