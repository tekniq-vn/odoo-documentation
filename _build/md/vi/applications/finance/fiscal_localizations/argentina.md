...
![Select AFIP Responsibility Type.](applications/finance/fiscal_localizations/argentina/select-responsibility-type.png)
...
![Select Fiscal Localization Package.](applications/finance/fiscal_localizations/argentina/select-fiscal-package.png)
...
![Select AFIP database environment: Testing or Production.](applications/finance/fiscal_localizations/argentina/select-environment.png)
...
1. Generate Certificate Sign Request (Odoo). When this option is selected, a file with
   ...
   ![Request a certificate.](applications/finance/fiscal_localizations/argentina/request-certificate.png)
...
3. Upload Certificate and Private Key (Odoo). Once the certificate is generated, upload
   ...
   ![Upload Certificate and Private Key.](applications/finance/fiscal_localizations/argentina/upload-certificate-private-key.png)
...
![A list of AR Localization document types in Odoo, as defined by AFIP.](applications/finance/fiscal_localizations/argentina/identification-types.png)
...
![Select AFIP Responsibility Type.](applications/finance/fiscal_localizations/argentina/select-afip-responsibility-type.png)
...
![A list of AR Localization taxes with financial amount and configuration in Odoo.](applications/finance/fiscal_localizations/argentina/automatic-tax-configuration.png)
...
by default.](applications/finance/fiscal_localizations/argentina/special-inactive-taxes.png)
...
![A list of document types in Odoo.](applications/finance/fiscal_localizations/argentina/default-document-type-info.png)
...
![document types grouped by letters.](applications/finance/fiscal_localizations/argentina/document-types-grouped-by-letters.png)
...
bills. For more detail on invoices, please refer to the section [2.3 document types](#document-types).
...
![A AFIP POS System field which is available on Sales journals in Odoo.](applications/finance/fiscal_localizations/argentina/sales-journal.png)
...
![Web Services.](applications/finance/fiscal_localizations/argentina/web-services.png)
...
- **Invoice for a customer IVA Responsable Inscripto, prefix A** is the type of document that shows
  ...
  ![Invoice for a customer IVA Responsable Inscripto, prefix A.](applications/finance/fiscal_localizations/argentina/prefix-a-invoice-for-customer.png)
- **Invoice for an end customer, prefix B** is the type of document that does not detail the taxes,
  ...
  ![Invoice for an end customer, prefix B.](applications/finance/fiscal_localizations/argentina/prefix-b-invoice-for-end-customer.png)
- **Exportation Invoice, prefix E** is the type of document used when exporting goods that shows
  the incoterm.
  ![Exportation Invoice, prefix E](applications/finance/fiscal_localizations/argentina/prefix-e-exporation-invoice.png)
...
![AFIP Status.](applications/finance/fiscal_localizations/argentina/afip-status.png)
...
- A. Tax excluded: in this case the taxed amount needs to be clearly identified in the
  ...
  **Responsable Inscripto**;
  ![Tax excluded.](applications/finance/fiscal_localizations/argentina/tax-amount-excluded.png)
- B. Tax amount included: this means that the taxed amount is included as part of the
  ...
  ![Tax amount included.](applications/finance/fiscal_localizations/argentina/tax-amount-included.png)
...
![Hoá đơn cho Dịch vụ.](applications/finance/fiscal_localizations/argentina/invoices-for-services.png)
...
![Service Dates.](applications/finance/fiscal_localizations/argentina/service-dates.png)
...
![Exporation journal.](applications/finance/fiscal_localizations/argentina/exporation-journal.png)
...
![Export invoice fields autofilled in Odoo.](applications/finance/fiscal_localizations/argentina/export-invoice.png)

#### NOTE
The Exportation Documents require Incoterms to be enabled and configured, which can be found in
Other Info ‣ Accounting.

![Export invoice - Incoterm.](applications/finance/fiscal_localizations/argentina/export-invoice-incoterm.png)
...
![Bank account relation error.](applications/finance/fiscal_localizations/argentina/bank-account-relation-error.png)

To set up the Transmission Mode, go to settings and select either SDC or
ADC.

![Transmission Mode.](applications/finance/fiscal_localizations/argentina/transmission-mode.png)
...
![Transmission Mode on Invoice.](applications/finance/fiscal_localizations/argentina/transmission-mode-on-invoice.png)
...
![Credit & debit notes buttons.](applications/finance/fiscal_localizations/argentina/credit-debit-notes-button.png)
...
2. the Credit Note, is created to annulate the FCE document, in this case the field
   FCE, is Cancellation? must be *empty* (false).

![FCE: Es Cancelación?](applications/finance/fiscal_localizations/argentina/fce-es-cancelation.png)

<a id="argentina-invoice-printed-report"></a>
...
![Invoice printed report.](applications/finance/fiscal_localizations/argentina/invoice-printed-report.png)
...
![Consult invoice in AFIP.](applications/finance/fiscal_localizations/argentina/consult-invoice-in-afip.png)![Details of invoice consulted in AFIP.](applications/finance/fiscal_localizations/argentina/consult-invoice-in-afip-details.png)
...
![Consult the last invoice number.](applications/finance/fiscal_localizations/argentina/consult-last-invoice-number.png)
...
![Changing journal and document type.](applications/finance/fiscal_localizations/argentina/changing-journal-document-type.png)
...
![Vendor bill document number.](applications/finance/fiscal_localizations/argentina/vendor-bill-document-number.png)
...
![Verify Vendor Bills validity in AFIP.](applications/finance/fiscal_localizations/argentina/verify-vendor-bills.png)
...
![Xác minh trên AFIP.](applications/finance/fiscal_localizations/argentina/verify-on-afip.png)
...
![Xác thực AFIP bị từ chối.](applications/finance/fiscal_localizations/argentina/afip-auth-rejected.png)
...
![VAT exempt.](applications/finance/fiscal_localizations/argentina/vat-exempt.png)
...
![Enter the perception amount.](applications/finance/fiscal_localizations/argentina/enter-perception-amount.png)
...
![l10n_latam_check module.](applications/finance/fiscal_localizations/argentina/l10n-latam-check-module.png)
...
![Cấu hình sổ nhật ký ngân hàng.](applications/finance/fiscal_localizations/argentina/bank-journal-conf.png)
...
![Payment pop-up window with own check options enabled.](applications/finance/fiscal_localizations/argentina/payment-popup-vendorbill.png)
...
![Own checks menu location.](applications/finance/fiscal_localizations/argentina/checks-menu-vendorbill.png)
...
![Own checks menu organization and filtering.](applications/finance/fiscal_localizations/argentina/check-menu-list-vendorbill.png)
...
![Empty Check button to cancel Own Checks](applications/finance/fiscal_localizations/argentina/empty-check-button.png)
...
- Select Cash as Type
- In the Journal Entries tab, set Cash Account: to `1.1.1.02.010 Cheques de
  Terceros`, input a Short Code of your choice, and select a Currency

![Automatically created cash account.](applications/finance/fiscal_localizations/argentina/auto-cash-account.png)
...
- For new incoming third party checks, go to Incoming Payments tab ‣ Add a line
  and select New Third Party Checks. This method is used to create *new* third party
  checks.
...
![Payment methods automatically created.](applications/finance/fiscal_localizations/argentina/auto-payment-methods.png)
...
- Select Cash as Type
- In the Journal Entries tab, set Cash Account: to `1.1.1.01.002 Rejected
  Third Party Checks`, input a Short Code of your choice, and select a
  Currency
...
To register a *new* third party check for a customer invoice, click the Register Payment
...
![Payment pop-up window with New Third Party Check options enabled.](applications/finance/fiscal_localizations/argentina/third-party-payment-popup.png)
...
![Payment pop-up window with Existing Third Party Check options enabled.](applications/finance/fiscal_localizations/argentina/existing-third-party-popup.png)
...
![Check Operations menu.](applications/finance/fiscal_localizations/argentina/check-operations-menulist.png)
...
<a id="argentina-ecommerce-electronic-invoicing"></a>
...
Once all of the configurations are made for the Argentinian [electronic invoice](#argentina-configure-your-company) flow, it is also necessary to complete certain configurations to
...
![Feature activated to invoice automatically.](applications/finance/fiscal_localizations/argentina/l10nar-automatic-invoicing-ecommerce.png)
...
![Fiscal required fields for electronic invoicing.](applications/finance/fiscal_localizations/argentina/l10nar-fiscal-fields-ar-ecommerce.png)
...
![l10n_ar Purchase Journal Configuration.](applications/finance/fiscal_localizations/argentina/l10n-ar-purchase-journal.png)
...
![l10n_ar Sales Journal Configuration.](applications/finance/fiscal_localizations/argentina/l10n-ar-sales-journal.png)
...
the <i class="fa fa-book"></i> (book), and select Argentinean VAT book (AR).
...
![IIBB Sales by jurisdiction.](applications/finance/fiscal_localizations/argentina/iibb-sales-jurisdiction.png)
...
![IIBB Purchases by jurisdiction.](applications/finance/fiscal_localizations/argentina/iibb-purchases-jurisdiction.png)
