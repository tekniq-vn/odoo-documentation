...
3. Upload Certificate and Private Key (Odoo). Once the certificate is generated, upload
   ...
   ![Upload Certificate and Private Key.](../../../_images/upload-certificate-private-key.png)
...
- **Invoice for a customer IVA Responsable Inscripto, prefix A** is the type of document that shows
  ...
  ![Invoice for a customer IVA Responsable Inscripto, prefix A.](../../../_images/prefix-a-invoice-for-customer.png)
- **Invoice for an end customer, prefix B** is the type of document that does not detail the taxes,
  ...
  ![Invoice for an end customer, prefix B.](../../../_images/prefix-b-invoice-for-end-customer.png)
- **Exportation Invoice, prefix E** is the type of document used when exporting goods that shows
  the incoterm.
  ![Exportation Invoice, prefix E](../../../_images/prefix-e-exporation-invoice.png)
...
![l10n_ar Purchase Journal Configuration.](../../../_images/l10n-ar-purchase-journal.png)
...
![l10n_ar Sales Journal Configuration.](../../../_images/l10n-ar-sales-journal.png)
