...
Install the 🇧🇪 Belgium [fiscal localization package](./#fiscal-localizations-packages) to get all the default accounting features of the Belgian
...
#### IMPORTANT
Make sure the [company settings](../../general/companies/) are correctly
...
1. [Create a new bank journal](../accounting/bank/).
