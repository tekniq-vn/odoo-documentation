...
Checks Layout* (`l10n_ca_check_printing`) module for the CA localization is [installed](applications/general/apps_modules.md#general-install).
...
[integration with Stripe](applications/finance/payment_providers/stripe.md).
