...
information on how to do this can be found in this documentation:[Communication in Odoo by email](applications/general/email_communication.md)
...
* The file is created automatically and recorded\
  in the chatter.
* The\
  status is set as Pending to be sent.![DTE XML File displayed in chatter.](../../../.gitbook/assets/xml-creation.png)
...
2.  Once the response is received, Odoo updates the\
    ...
    Rejected.![Identification transaction for invoice and Status update.](../../../.gitbook/assets/dte-status-steps.png)
    ...
    **IMPORTANT**
    ...
    SII for smooth processing.![Electronic invoice data statuses.](../../../.gitbook/assets/chatter-internal-statuses.png)
...
![phân hệ l10n\_cl Thương mại điện tử.](../../../.gitbook/assets/ecommerce-module-chile.png)
...
![phân hệ l10n\_cl POS EDI.](../../../.gitbook/assets/pos-edi-module-chile.png)
...
made using the _Accounting_ app. See the [credit notes and refunds](applications/finance/accounting/customer_invoices/credit_notes.md) documentation for detailed instructions.
