...
| ----------------------------------------------- | ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Colombia - Kế toán                              | `l10n_co`         | <p>Default <a href="applications/finance/fiscal_localizations.md#fiscal-localizations-packages">fiscal localization package</a>. This module adds<br>the base accounting features for the Colombian localization: chart of accounts, taxes,<br>withholdings, and identification document type.</p> |
