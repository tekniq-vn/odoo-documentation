...
| ----------------------------------------------- | ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Colombia - Kế toán                              | `l10n_co`         | <p>Default <a href="../fiscal_localizations.md#fiscal-localizations-packages">fiscal localization package</a>. This module adds<br>the base accounting features for the Colombian localization: chart of accounts, taxes,<br>withholdings, and identification document type.</p> |
...
| Electronic invoicing for Colombia with Carvajal | `l10n_co_edi`     | <p>This module includes the features required for integration with Carvajal, and<br>generates the electronic invoices and support documents related to the vendor bills, based on<br>regulations.</p>                                                                            |
...
* Identification Number: Select the Identification Type (`NIT`, `Cédula de Ciudadanía`, `Registro Civil`, etc.). When the Identification Type is `NIT`, the\
  Identification Number **must** have the _verification digit_ at the end of the ID\
...
* Gran Contribuyente: If the company is _Gran Contribuyente_ this option should be\
  selected.
...
![Configure credentials for Carvajal web service in Odoo.](../../../_images/carvajal-configuration.png)
...
![The ICA, IVA and Fuente fields in the Advanced Options tab in Odoo.](../../../_images/retention-tax-types.png)
...
Once the has assigned the official sequence and prefix for the _support document_ related to\
vendor bills, the purchase journals related to their supporting documents need to be updated in\
Odoo. The process is similar to the configuration of the [sales journals](colombia.md#co-journals).
...
![Electronic invoice workflow for Colombian localization.](../../../_images/workflow-electronic-invoice.png)
...
![Carvajal XML invoice file in Odoo chatter.](../../../_images/invoice-sent.png)
...
![ZIP file displayed in the invoice chatter in Odoo.](../../../_images/invoice-zip.png)
...
vendor bills, you can start using _support documents_.
...
During the XML validation, the most common errors are related to missing master data (_Contact Tax_\
_ID_, _Address_, _Products_, _Taxes_). In such cases, error messages are shown in the chatter after\
...
![XML validation errors shown in the invoice chatter in Odoo.](../../../_images/xml-validation-error.png)
...
![Certificado de Retención en ICA report in Odoo Accounting.](../../../_images/ica-report.png)
...
![Certificado de Retención en IVA report in Odoo Accounting.](../../../_images/iva-report.png)
...
![Certificado de Retención en Fuente report in Odoo Accounting.](../../../_images/fuente-report.png)
