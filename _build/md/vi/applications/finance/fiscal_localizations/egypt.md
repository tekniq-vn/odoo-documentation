...
| Tích hợp hóa đơn điện tử của Ai Cập | `l10n_eg_edi_eta` | [Egyptian Tax Authority (ETA) e-invoicing integration](egypt.md#egypt-e-invoicing)                                |
...
these codes to [configure your Odoo Accounting app](egypt.md#egypt-e-invoicing-configuration).
...
ETA Secret that you retrieved when you [registered Odoo on your ETA portal](egypt.md#egypt-e-invoicing-eta-portal). Set an invoicing threshold if needed.
...
Most of these codes are handled automatically by Odoo, provided that your [branches](egypt.md#egypt-e-invoicing-branches), [customers](egypt.md#egypt-e-invoicing-customers), and [products](egypt.md#egypt-e-invoicing-products) are correctly configured.
...
2. Input a Company name, the ETA USB Pin given to you by your USB key\
   ...
   installation](egypt.md#egypt-e-invoicing-local-proxy), then click on Save.
