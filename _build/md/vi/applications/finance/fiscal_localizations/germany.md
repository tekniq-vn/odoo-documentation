...
Then you can go in Accounting ‣ Reporting ‣ General Ledger then click on the
...
[fiskaly DSFinV-K API: VAT Definition](https://developer.fiskaly.com/api/dsfinvk/v0/#tag/VAT-Definition).
...
![Upgrading Odoo Point of Sale from the Apps dashboard](applications/finance/fiscal_localizations/germany/pos-upgrade.png)
...
![Button to register a company through fiskaly in Odoo](applications/finance/fiscal_localizations/germany/fiskaly-registration.png)
...
![fiskaly keys as displayed on Odoo](applications/finance/fiscal_localizations/germany/fiskaly-keys.png)
...
![Create TSS option from a point of sale](applications/finance/fiscal_localizations/germany/create-tss.png)
...
![Example of TSS ID and Client ID from fiskaly in Odoo Point of Sale](applications/finance/fiscal_localizations/germany/tss-ids.png)
...
![Menu to export DSFinV-K](applications/finance/fiscal_localizations/germany/dsfinv-k-export.png)
...
![Pending DSFinV-K export on Odoo](applications/finance/fiscal_localizations/germany/dsfinv-k-export-fields.png)
...
#### NOTE
If you can, the best way to understand GoBD is to Read the [Official GoBD text](https://ao.bundesfinanzministerium.de/ao/2021/Anhaenge/BMF-Schreiben-und-gleichlautende-Laendererlasse/Anhang-64/anhang-64.html).
