...
![Upgrading Odoo Point of Sale from the Apps dashboard](../../../_images/pos-upgrade.png)
...
![Button to register a company through fiskaly in Odoo](../../../_images/fiskaly-registration.png)
...
![Example of TSS ID and Client ID from fiskaly in Odoo Point of Sale](../../../_images/tss-ids.png)
...
![Pending DSFinV-K export on Odoo](../../../_images/dsfinv-k-export-fields.png)
