...
![Company data for Peru including RUC and Address type code.](../../../_images/peru-company.png)
...
![SUNAT displayed in Multicurrency Service option.](../../../_images/l10n-pe-banksync-sunat.png)

Please refer to the next section in our documentation for more information about[multicurrencies](../accounting/get_started/multi_currency.md).
...
* **Document type**: The default value is “Factura Electronica” but you can manually change the\
  document type if needed and select Boleta for example.![Invoice document type field on invoices.](../../../_images/peru-invoice-document-type.png)
...
![Message on chatter when the invoice is valid.](../../../_images/peru-invoice-sent.png)
...
* If the error is related to some data recorded on the invoice directly (Operation type, missing\
  ...
  changes, and then send the invoice again to the SUNAT for another validation.![List of common errors on invoices.](../../../_images/peru-errors.png)
...
![Cancellation CDR sent by the SUNAT.](../../../_images/peru-cancellation-cdr.png)
...
![Invoice after cancellation.](../../../_images/peru-cancelled.png)
...
1. All the products included in the invoice must have these fields configured:![Detraction fields on products.](../../../_images/peru-detraction.png)
2. Operation type in your invoice must be `1001`![Detraction code on invoices.](../../../_images/peru-detraction-invoice.png)
...
* The delivery guide is dependent on the Odoo _Inventory_ app, the l10n\_pe\_edi and\
  l10n\_pe modules.
* A second user **must** be added for the creation of electronic documents.

After following the steps to configure the [electronic invoicing](peru.md#peru-accounting-settings)\
and the [master data](peru.md#peru-master-data), [install](../../general/apps_modules.md#general-install) the\
...
![Example for the SUNAT Delivery Guide API section configuration.](../../../_images/gre-fields-example.png)
...
![Individual type operator configurations in the Contact form.](../../../_images/operator-configuration.png)
...
![Company type operator configurations in the Contact form.](../../../_images/company-operator-configuration.png)
...
![Vehicle not selected as an M1 or L type with extra fields shown.](../../../_images/vehicle-not-m1-or-l-pe.png)
...
![Generar Guia de Remision button on a transfer form in the Done stage.](../../../_images/generate-gre-transferview.png)
...
![Transfer details and QR code on generated delivery slip.](../../../_images/gre-delivery-slip.png)
...
* **Costing method:** Storable goods must use a [costing method](../../inventory_and_mrp/inventory/product_management/inventory_valuation/inventory_valuation_config.md)**other** than Standard Price, as the journal entries generated from stock moves are\
...
Transferring inventory is a key process captured in the 12.1 and 13.1 reports.[Inventory transfers](../../inventory_and_mrp/inventory/shipping_receiving/daily_operations.md)\
...
![Export Buttons selection](../../../_images/l10n-ple-export-button.png)
