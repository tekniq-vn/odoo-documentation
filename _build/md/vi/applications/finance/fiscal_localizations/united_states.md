...
![The Generic Chart Template comes pre-configured for the US localization.](applications/finance/fiscal_localizations/united_states/us-l10n-generic-chart-template.png)
...
![Chart of Accounts grouped by Account Type.](applications/finance/fiscal_localizations/united_states/us-l10n-coa-account-types.png)
...
- an *entries type* filter, as indicated by a <i class="fa fa-filter"></i> (filter) icon, with the
  ...
  - There are view options in this filter, as well, one that will Hide lines at 0 for
    ...
    ![Accounting method filter menu for reports, covering accrual vs. cash basis methods.](applications/finance/fiscal_localizations/united_states/us-l1on-accounting-method-reporting-menu.png)
...
![Examples of tagged accounts that are included in the Cash Flow Statement in Odoo.](applications/finance/fiscal_localizations/united_states/us-l10n-cash-flow-statement-tags.png)
...
![NACHA (National Automated Clearing House Association) configuration settings on Odoo.](applications/finance/fiscal_localizations/united_states/us-l10n-nacha-settings.png)
...
![NACHA settings with the standard entry class code drop-down menu highlighted.](applications/finance/fiscal_localizations/united_states/us-l10n-nacha-dropdown.png)
...
selected.](applications/finance/fiscal_localizations/united_states/us-l10n-create-batch-payments.png)
...
![The exported file tab highlighted in the batch payment with the download circled.](applications/finance/fiscal_localizations/united_states/us-l10n-batch-file.png)
