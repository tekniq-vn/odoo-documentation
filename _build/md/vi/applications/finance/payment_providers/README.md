...
* [Adyen](adyen.md)
* [Alipay](alipay.md)
* [Dịch vụ thanh toán Amazon](amazon_payment_services.md)
* [AsiaPay](asiapay.md)
* [Authorize.Net](authorize.md)
* [Buckaroo](buckaroo.md)
* [Demo](demo.md)
...
|-------------------------------------------------------|----------------------------|------------------------------------------------|---------------------------------------------------------|-------------------------------------------|-----------------------------------------------------------|
| [Adyen](adyen.md)                                     | Odoo                       | ✔                                              | Toàn bộ và một phần                                     | Toàn bộ và một phần                       |                                                           |
| [Amazon Payment Services](amazon_payment_services.md) | Trang web của nhà cung cấp |                                                |                                                         |                                           |                                                           |
| [AsiaPay](asiapay.md)                                 | Trang web của nhà cung cấp |                                                |                                                         |                                           |                                                           |
| [Authorize.Net](authorize.md)                         | Odoo                       | ✔                                              | Full only                                               | Full only                                 |                                                           |
| [Buckaroo](buckaroo.md)                               | Trang web của nhà cung cấp |                                                |                                                         |                                           |                                                           |
| [Flutterwave](flutterwave.md)                         | Trang web của nhà cung cấp | ✔                                              |                                                         |                                           |                                                           |
| [Mercado Pago](mercado_pago.md)                       | Trang web của nhà cung cấp |                                                |                                                         |                                           |                                                           |
| [Mollie](mollie.md)                                   | Trang web của nhà cung cấp |                                                |                                                         |                                           |                                                           |
| [PayPal](paypal.md)                                   | Trang web của nhà cung cấp |                                                |                                                         |                                           |                                                           |
| [Razorpay](razorpay.md)                               | Odoo                       | ✔                                              | Full only                                               | Toàn bộ và một phần                       |                                                           |
| [SIPS](sips.md)                                       | Trang web của nhà cung cấp |                                                |                                                         |                                           |                                                           |
| [Stripe](stripe.md)                                   | Odoo                       | ✔                                              | Full only                                               | Toàn bộ và một phần                       | ✔                                                         |
| [Xendit](xendit.md)                                   | Trang web của nhà cung cấp |                                                |                                                         |                                           |                                                           |

#### NOTE
- Each provider has its own specific configuration flow, depending on which feature is
  available.
- Some of these online payment providers can also be added as [bank accounts](../accounting/bank/), but this is **not** the same process as adding them as payment
...
A [payment journal](../accounting/bank/) must be defined for the payment provider to record the
...
- Payment journals must only be configured if the [Invoicing or Accounting app](../accounting/)
  is installed.
...
By default, the Bank Account defined for the [payment journal](#payment-providers-journal) is used, but you can also specify an [outstanding account](../accounting/bank/#bank-outstanding-accounts) for each payment provider to separate the provider's payments from
other payments.
