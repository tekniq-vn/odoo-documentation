...
Access email templates in [developer mode](applications/general/developer_mode.md#developer-mode) by navigating to
...
To access the XML/HTML editor for an email template, first enter [developer mode](applications/general/developer_mode.md#developer-mode). Then, click the </> icon in the upper-right corner of the template,
and proceed to edit the XML/HTML. To return to the standard text editor, click the </>
icon again.

![HTML editor in the email template.](../../../.gitbook/assets/html-code-editor.png)
...
![Using dynamic placeholders in an email template.](../../../.gitbook/assets/dynamic-placeholders.png)
...
![Rich text editor in the email template.](../../../.gitbook/assets/rich-text-editor.png)
...
![Resetting the email template.](../../../.gitbook/assets/reset.png)
...
![Reply-to field on template.](../../../.gitbook/assets/reply-to-template-sales.png)
...
![Email composer in mass mailing mode with reply-to highlighted.](../../../.gitbook/assets/composer-mass-mailing.png)
...
parameters. For more information about this, see [system parameters](applications/websites/website/configuration/domain_names.md#domain-name-web-base-url).
...
For more information about how to configure domains, check out the [domain name documentation](applications/websites/website/configuration/domain_names.md).
...
In order to edit translations, first enter [developer mode](applications/general/developer_mode.md#developer-mode). Then, on the
...
![Edit the language of a template.](../../../.gitbook/assets/edit-language-template.png)
...
![Translation of the body of the Appointment Booked template.](../../../.gitbook/assets/translation-body.png)
