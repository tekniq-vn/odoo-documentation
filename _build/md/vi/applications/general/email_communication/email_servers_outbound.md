...
![Odoo’s default outbound messages configuration.](../../../_images/diagram-inbound-mailing-method.png)
...
<a id="email-outbound-custom-domain"></a>
...
<a id="email-outbound-custom-domain-odoo-server"></a>
...
![Technical schema of external mail server configuration with Odoo.](../../../_images/diagram-owned-domain-odoo-server.png)
...
<a id="email-outbound-custom-domain-smtp-server"></a>
...
<a id="email-outbound-custom-domain-smtp-server-local-part"></a>
...
<a id="email-outbound-different-servers-personalized"></a>
...
![Example of split between transaction and mass mailing mail servers.](../../../_images/split-transaction-massmail-mail-servers.png)
...
![Dedicated mail server on Email Marketing app settings.](../../../_images/dedicated-mass-mail-server.png)
...
<a id="email-outbound-different-servers-external-odoo"></a>
...
![Adding a mail server using the Odoo's mail server with the CLI authentication.](../../../_images/command-line-interface-option-mail-server.png)![Splitting of Odoo mail server for transactional emails and Mail server for Mass mailing.](../../../_images/split-mail-servers.png)
...
<a id="email-outbound-alias-domain"></a>
...
<a id="email-outbound-notifications"></a>
...
<a id="email-outbound-unique-address"></a>
