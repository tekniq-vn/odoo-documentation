...
![A new contract template form, with the fields filled in.](../../_images/contract-template.png)
...
![The salary information tab, with the fields filled in.](../../_images/salary-information.png)
...
![The employment types in the database by default, in a list view.](../../_images/employment-types.png)
...
![List of all work entry types currently available for use, with the payroll code and color.](../../_images/work-entry-types.png)
...
![New work entry type form with all fields to be filled in.](../../_images/new-work-entry-type.png)
...
![All working schedules available to use currently set up in the database for the company.](../../_images/working-schedules.png)
...
![List of all currently configured structure types available to use.](../../_images/structure-type.png)
...
![New structure type form to fill out when creating a new structure type.](../../_images/new-structure.png)
...
![Salary structure details for Regular Pay, listing all the specific Salary Rules.](../../_images/structure-regular-pay-rules.png)
...
![Enter the information for the new rule on the new rule form.](../../_images/new-rule.png)
...
a payslip.](../../_images/other-input.png)
...
![A new Input Type form filled in.](../../_images/input-type-new.png)
...
![A list view of all the benefits available for each structure type.](../../_images/benefits.png)
...
![A new benefit form filled out for an internet subscription.](../../_images/new-benefit.png)
...
![A list of all the personal information that appears on the employee card to enter.](../../_images/personal-info.png)
...
![The net wage rule form filled out, with all the information for net pay.](../../_images/resume-net.png)
...
![A list of all the job positions and corresponding departments.](../../_images/job-positions.png)
