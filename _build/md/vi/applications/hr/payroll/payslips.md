...
- New status: batches without any payslips added to them have a status of
  ...
  > ![A batch with a status of new, with the available buttons highlighted.](../../../_images/batch-new.png)
...
- Confirmed status: batches that have been created and have payslips in them, but the
  ...
  ![A batch with a status of confirmed, with the available buttons highlighted.](../../../_images/batch-confirmed.png)
...
- Done status: batches with confirmed payslips in them have a status of
  ...
  ![A batch with a status of done, with the available buttons highlighted.](../../../_images/batch-done.png)
...
- Paid status: batches that have been completed have a status of Paid. No
  ...
  ![A batch with a status of paid, with the available buttons highlighted.](../../../_images/batch-paid-2.png)
