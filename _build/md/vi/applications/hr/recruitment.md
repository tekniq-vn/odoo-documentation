...
![The resumé on an applicant's card, appearing on the right side.](../../_images/cv-display.png)
...
![Main dashboard view of job position card, showing new applications button.](../../_images/new-applicants-button.png)
...
![Expand a folded column by clicking on it in the Kanban view.](../../_images/stages.png)
...
![The applicant card statuses, and status bar.](../../_images/status-dots.png)
...
![The plus sign to click to add a new column to the Kanban stages.](../../_images/add-column.png)
...
displays when clicked.](../../_images/gear.png)
...
pre-configured template.](../../_images/send-survey.png)
