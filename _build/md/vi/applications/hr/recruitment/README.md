...
![The resumé on an applicant's card, appearing on the right side.](../../../.gitbook/assets/cv-display.png)
...
![Main dashboard view of job position card, showing new applications button.](../../../.gitbook/assets/new-applicants-button.png)
...
- [Mới](recruitment-flow.md#recruitment-new)
- [Đánh giá sơ bộ](recruitment-flow.md#recruitment-initial-qualification)
- [Phỏng vấn lần đầu](recruitment-flow.md#recruitment-first-interview)
- [Phỏng vấn lần hai](recruitment-flow.md#recruitment-second-interview)
- [Đề xuất hợp đồng](offer_job_positions.md)
- [Hợp đồng được ký](offer_job_positions.md#recruitment-offer-job-positions-contract-signed)
...
#### SEE ALSO
- [Job positions](new_job.md)
- [Add new applicants](add-new-applicants.md)
- [Schedule interviews](schedule_interviews.md)
- [Offer job positions](offer_job_positions.md)
- [Refuse applicants](refuse_applicant.md)
- [Source analysis reporting](source_analysis.md)
- [Recruitment analysis](recruitment_analysis.md)
- [Time in stage analysis](time_in_stage.md)
- [Team performance reporting](team_performance.md)

* [Job positions](new_job.md)
* [Recruitment flow](recruitment-flow.md)
* [Add new applicants](add-new-applicants.md)
* [Schedule interviews](schedule_interviews.md)
* [Offer job positions](offer_job_positions.md)
* [Refuse applicants](refuse_applicant.md)
