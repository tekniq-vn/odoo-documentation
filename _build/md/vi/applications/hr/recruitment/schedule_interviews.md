...
![The calendar view, highlighting how to change the displayed meetings.](../../../_images/calendar.png)
...
![A new meeting card with all the details populated, and ready to save.](../../../_images/new-event.png)
...
![Enter the information to send the event via email.](../../../_images/email-event.png)
...
![Send a text message to the attendees of the meeting.](../../../_images/send-sms.png)
...
![The drop-down that appears after clicking the cog.](../../../_images/edit-stage.png)
...
![The Recruitment: Schedule Interview email template populating the Email Template field.](../../../_images/interview-template.png)
...
interviewer.](../../../_images/select-interviewer.png)
...
![The calendar screen with dates and times to schedule an interview.](../../../_images/select-date-time.png)
...
![The confirmation page with all the details for the interview displayed.](../../../_images/confirmation.png)
