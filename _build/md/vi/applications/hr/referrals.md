...
related to the [rewards](referrals/rewards.md); everything else is pre-configured when Odo&#x6F;_&#x52;eferrals_ is installed.
...
and access rights, refer to these documents: [Người dùng](../general/users.md) and[Quyền truy cập](../general/users/access_rights.md).
...
![An onboarding slide with the skip and next buttons visible at the bottom.](../../_images/onboarding.png)
...
at the end of onboarding, instead of going to the main dashboard, a [hired](referrals.md#referrals-hired) screen appears instead.
...
![An onboarding slide in edit mode, with the main fields highlighted.](../../_images/edit-onboarding.png)
...
![The onboarding slides in a list, with the drag and drop arrows highlighted.](../../_images/onboarding-reorder.png)
...
chosen are greyed out.](../../_images/avatars.png)

### Modify friends

Có thể chỉnh sửa ảnh đại diện của bạn bè theo cùng cách mà [cấp độ](referrals.md#referrals-levels) được chỉnh sửa. Chỉ những người dùng có quyền Quản trị viên trên ứng dụng _Tuyển dụng_ mới có thể chỉnh sửa bạn bè. Có thể xem và chỉnh sửa bạn bè được cấu hình sẵn bằng cách điều hướng đến Ứng dụng Giới thiệu ‣ Cấu hình ‣ Bạn bè. Mỗi ảnh đại diện của bạn bè sẽ xuất hiện trong cột Hình ảnh trang chủ và tên tương ứng sẽ xuất hiện trong cột Tên bạn bè. Các ảnh mặc định là một nhóm nhân vật anh hùng đa dạng, từ rô-bốt đến chó.
...
above their image.](../../_images/level-up.png)
