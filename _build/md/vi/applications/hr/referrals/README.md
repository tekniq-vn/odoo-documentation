...
related to the [rewards](rewards.md); everything else is pre-configured when Odoo
...
the [reporting](reporting.md) and configurations menus. For more information on users
and access rights, refer to these documents: [Người dùng](../../general/users/) and
...
#### SEE ALSO
- [Share job positions](share_jobs.md)
- [Referral points](points.md)
- [Phần thưởng](rewards.md)
- [Cảnh báo](alerts.md)
- [Báo cáo](reporting.md)

* [Share job positions](share_jobs.md)
  * [Xem công việc](share_jobs.md#view-jobs)
  * [Refer friends](share_jobs.md#refer-friends)
  * [Share a job](share_jobs.md#share-a-job)
    * [Liên kết](share_jobs.md#link)
    * [Facebook](share_jobs.md#facebook)
    * [X (trước đây là Twitter)](share_jobs.md#x-formerly-twitter)
    * [LinkedIn](share_jobs.md#linkedin)
    * [Gửi email cho một người bạn](share_jobs.md#email-a-friend)
* [Referral points](points.md)
  * [My referrals](points.md#my-referrals)
    * [Điểm](points.md#points)
* [Phần thưởng](rewards.md)
  * [Create rewards](rewards.md#create-rewards)
  * [Redeem rewards](rewards.md#redeem-rewards)
* [Cảnh báo](alerts.md)
  * [Create an alert](alerts.md#create-an-alert)
  * [Dismiss an alert](alerts.md#dismiss-an-alert)
* [Báo cáo](reporting.md)
  * [Employees referral analysis report](reporting.md#employees-referral-analysis-report)
    * [Use case: hired referrals](reporting.md#use-case-hired-referrals)
