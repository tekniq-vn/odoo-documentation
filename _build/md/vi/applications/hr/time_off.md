...
Detailed [reports](time_off.md#time-off-reporting) can be run to see how much time off (and what kinds of\
time off) are being used, [accrual plans](time_off.md#time-off-accrual-plans) can be created, and[public holidays](time_off.md#time-off-public-holidays) can be set.
...
To better understand how access rights affect the **Time Off** app, refer to the[Nhân viên mới](employees/new_employee.md) document, specifically the section about configuring the work\
information tab.
...
* Approval: select what specific kind of approval is required for the time off type. The\
  ...
  * By Time Off Officer: Only the specified [Time Off Officer](time_off.md#time-off-time-off-officer), set on this form in the Notified Time Off Officer\
  ...
  * By Employee's Approver: Only the employee's specified approver for time off, which\
    is set on the _Work Information_ tab on the [employee's form](employees/new_employee.md#employees-work-info-tab), is\
    required to approve the time off request.
  * By Employee's Approver and Time Off Officer: Both the employee's [specified\
    time off approver](employees/new_employee.md#employees-work-info-tab) and the [Time Off Officer](time_off.md#time-off-time-off-officer) are required to approve the time off request.
...
* Approval: Select the type of approvals required for the allocation of this particular\
  time off type.
  * Approved by Time Off Officer indicates the [Time Off Officer](time_off.md#time-off-time-off-officer) set on this form must approve the allocation.
...
off.](../../_images/time-off-type-form-top.png)
...
The Timesheets section only appears if the user is in developer mode. Refer to the[Chế độ lập trình viên (chế độ gỡ lỗi)](../general/developer_mode.md#developer-mode) document for details on how to access the developer mode.
...
off.](../../_images/time-off-type-form-bottom.png)
...
![An accrual plan form with all the entries filled out.](../../_images/accrual-plan-form.png)
...
![A milestone form with all the entries filled out.](../../_images/milestone.png)
...
![The list of public holidays in the configuration menu.](../../_images/holidays.png)
...
![The Mandatory Days section with three configured days.](../../_images/mandatory.png)
...
![Overview of the user's team, with time off requests shown.](../../_images/overview1.png)
...
![Report of time off, shown by each employee in a list view.](../../_images/employee-report1.png)
...
highlighted in a red box.](../../_images/bar-chart3.png)
