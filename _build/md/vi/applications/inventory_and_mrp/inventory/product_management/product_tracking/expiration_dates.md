...
![Enabled lots and serial numbers and expiration dates settings.](../../../../../.gitbook/assets/expiration-dates-enabled-settings.png)
...
![Expiration dates configuration on the product form.](../../../../../.gitbook/assets/expiration-dates-product-configuration.png)
...
![User error popup when validating an order with no lot number.](../../../../../.gitbook/assets/expiration-dates-user-error-popup.png)
...
![Detailed operations popup showing expiration dates for ordered products.](../../../../../.gitbook/assets/expiration-dates-detailed-operations-popup.png)
...
![Manufacturing order for product with expiration date.](../../../../../.gitbook/assets/expiration-dates-manufacturing-order.png)
...
![Dates tab with expiration information for specific lot number.](../../../../../.gitbook/assets/expiration-dates-dates-tab-lot-number.png)
...
![Group by expiration dates on lots and serial numbers page.](../../../../../.gitbook/assets/expiration-dates-group-by-dates.png)
...
![Expiration alert for product past the expiration date.](../../../../../.gitbook/assets/expiration-dates-expiration-alert.png)
