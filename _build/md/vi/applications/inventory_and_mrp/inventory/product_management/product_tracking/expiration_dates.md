...
![Enabled lots and serial numbers and expiration dates settings.](../../../../../_images/expiration-dates-enabled-settings.png)
...
![Expiration dates configuration on the product form.](../../../../../_images/expiration-dates-product-configuration.png)
...
![User error popup when validating an order with no lot number.](../../../../../_images/expiration-dates-user-error-popup.png)
...
![Detailed operations popup showing expiration dates for ordered products.](../../../../../_images/expiration-dates-detailed-operations-popup.png)
...
![Manufacturing order for product with expiration date.](../../../../../_images/expiration-dates-manufacturing-order.png)
...
![Dates tab with expiration information for specific lot number.](../../../../../_images/expiration-dates-dates-tab-lot-number.png)
...
![Group by expiration dates on lots and serial numbers page.](../../../../../_images/expiration-dates-group-by-dates.png)
...
![Expiration alert for product past the expiration date.](../../../../../_images/expiration-dates-expiration-alert.png)
