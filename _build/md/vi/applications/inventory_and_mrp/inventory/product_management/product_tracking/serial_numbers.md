...
![Cài đặt số lô và sê-ri đã bật.](../../../../../_images/serial-numbers-enabled-setting.png)
...
![Bật tính năng theo dõi bằng số sê-ri trên biểu mẫu sản phẩm.](../../../../../_images/serial-numbers-product-tracking.png)
...
![Đã tạo số sê-ri mới cho sản phẩm hiện có.](../../../../../_images/serial-numbers-new-serial-number.png)
...
![Mành hình chứa biểu tượng danh sách có dấu đầu dòng và các nút thông minh Hoạt động chi tiết.](../../../../../_images/assign-serial-numbers1.png)
...
![Cửa sổ pop-up báo lỗi người dùng yêu cầu nhập số sê-ri.](../../../../../_images/serial-numbers-user-error-popup.png)
...
![Tự động gán số sê-ri trong cửa sổ pop-up hoạt động chi tiết.](../../../../../_images/serial-numbers-auto-assign-sn.png)
...
![Danh sách số sê-ri được sao chép trong bảng tính Excel.](../../../../../_images/serial-numbers-excel-spreadsheet.png)
...
![Số sê-ri được liệt kê trong cửa sổ bật lên chi tiết thao tác.](../../../../../_images/serial-numbers-detailed-operations-popup.png)
...
![Đã bật cài đặt truy xuất nguồn gốc trong biểu mẫu loại hoạt động.](../../../../../_images/serial-numbers-operations-types.png)
...
![Trang báo cáo số sê-ri với danh sách thả xuống.](../../../../../_images/serial-numbers-reporting-page.png)
