...
![In stock products listed on the Inventory adjustments page.](applications/inventory_and_mrp/inventory/warehouses_storage/inventory_management/count_products/inventory-adjustments-page.png)
...
![Difference column on inventory adjustments page.](applications/inventory_and_mrp/inventory/warehouses_storage/inventory_management/count_products/difference-column.png)
...
![Apply all option applies the inventory adjustment once a reason is specified.](applications/inventory_and_mrp/inventory/warehouses_storage/inventory_management/count_products/apply-inventory-adjustment.png)
...
![Zero count inventory adjustment move.](applications/inventory_and_mrp/inventory/warehouses_storage/inventory_management/count_products/zero-move.png)
...
![Inventory Adjustments History dashboard detailing a list of prior product moves.](applications/inventory_and_mrp/inventory/warehouses_storage/inventory_management/count_products/history-inventory-adjustments.png)
...
![Inventory Adjustments Actions menu.](applications/inventory_and_mrp/inventory/warehouses_storage/inventory_management/count_products/inventory-adjustment-actions.png)
...
![Request a count popup on inventory adjustments page.](applications/inventory_and_mrp/inventory/warehouses_storage/inventory_management/count_products/count-popup.png)
