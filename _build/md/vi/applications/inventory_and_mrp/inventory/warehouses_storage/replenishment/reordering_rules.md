...
* [Manual](reordering_rules.md#inventory-warehouses-storage-manual-rr): The [Replenishment report](applications/inventory_and_mrp/inventory/warehouses_storage/replenishment/report.md)\
...
*   Procurement Group: This is a way to group related or that are tied to\
    ...
    **NOTE**
    ...
    using the [MTO route](applications/inventory_and_mrp/inventory/warehouses_storage/replenishment/mto.md).![Showing smart button to PO.](../../../../../.gitbook/assets/po-smartbutton.png)
