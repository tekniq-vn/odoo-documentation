...
![New event creation pop-up window.](maintenance_calendar/maintenance-calendar-new-event-popup.png)
...
![New maintenance request form creation.](maintenance_calendar/maintenance-calendar-new-request-form.png)
...
![Filled-out details of maintenance request form.](maintenance_calendar/maintenance-calendar-filled-out-form.png)
...
![Instructions tab options on maintenance request form.](maintenance_calendar/maintenance-calendar-instructions-tab.png)
...
![Favorites section of filters drop-down menu.](maintenance_calendar/maintenance-calendar-favorites-popover.png)
...
![Different view type icons for maintenance calendar.](maintenance_calendar/maintenance-calendar-view-type-icons.png)
...
![Calendar period drop-down menu options.](maintenance_calendar/maintenance-calendar-period-dropdown.png)
...
![Column options for stage in Kanban view.](maintenance_calendar/maintenance-calendar-kanban-column.png)
...
![Edit In Progress pop-up window.](maintenance_calendar/maintenance-calendar-edit-stage-popup.png)
...
![Measures options on Pivot view page.](maintenance_calendar/maintenance-calendar-measures-menu.png)
...
![Graph type icons on Graph view page.](maintenance_calendar/maintenance-calendar-graph-view-icons.png)
...
![Maintenance requests on Activity view.](maintenance_calendar/maintenance-calendar-activity-view-type.png)
...
![Schedule Activity pop-up window.](maintenance_calendar/maintenance-calendar-schedule-activity-popover.png)
...
![Odoo pop-up schedule activity window.](maintenance_calendar/maintenance-calendar-odoo-activity-popup.png)
