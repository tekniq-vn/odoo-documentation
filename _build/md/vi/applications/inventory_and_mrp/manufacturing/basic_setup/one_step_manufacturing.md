...
![Nút Bắt đầu cho một hoạt động trên lệnh sản xuất.](one_step_manufacturing/start-button.png)
...
![Nút Hoàn tất cho một hoạt động trên lệnh sản xuất.](one_step_manufacturing/done-button.png)
...
![Nút Mở Xưởng để thực hiện công đoạn trong lệnh sản xuất.](one_step_manufacturing/shop-floor-button.png)
...
![Thẻ công đoạn trên trang khu vực sản xuất trong phân hệ Xưởng.](one_step_manufacturing/work-order-card.png)
