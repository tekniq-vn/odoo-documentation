...
![Nút Bắt đầu cho một hoạt động trên lệnh sản xuất.](../../../../_images/start-button.png)
...
![Nút Hoàn tất cho một hoạt động trên lệnh sản xuất.](../../../../_images/done-button.png)
...
![Nút Mở Xưởng để thực hiện công đoạn trong lệnh sản xuất.](../../../../_images/shop-floor-button.png)
...
![Thẻ công đoạn trên trang khu vực sản xuất trong phân hệ Xưởng.](../../../../_images/work-order-card.png)
