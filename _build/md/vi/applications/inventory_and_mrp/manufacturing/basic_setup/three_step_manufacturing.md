...
![Breadcrumb của lệnh sản xuất trên một lệnh chuyển thành phần.](../../../../_images/mo-bread-crumb.png)
...
![Nút Bắt đầu cho công đoạn trong lệnh sản xuất.](../../../../_images/start-button-2.png)
...
![Nút Hoàn tất cho công đoạn trong lệnh sản xuất.](../../../../_images/done-button1.png)
...
![Nút Mở Xưởng để thực hiện công đoạn trong lệnh sản xuất.](../../../../_images/shop-floor-button1.png)
...
![Thẻ công đoạn trên trang khu vực sản xuất trong phân hệ Xưởng.](../../../../_images/work-order-card1.png)
