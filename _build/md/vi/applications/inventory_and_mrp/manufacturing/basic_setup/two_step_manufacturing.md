...
![Breadcrumb của lệnh sản xuất trên một lệnh chuyển thành phần.](../../../../_images/mo-bread-crumb1.png)
...
![Nút Bắt đầu cho công đoạn trong lệnh sản xuất.](../../../../_images/start-button1.png)
...
![Nút Hoàn tất cho công đoạn trong lệnh sản xuất.](../../../../_images/done-button2.png)
...
![Nút Mở Xưởng để thực hiện công đoạn trong lệnh sản xuất.](../../../../_images/shop-floor-button2.png)
...
![Thẻ công đoạn trên trang khu vực sản xuất trong phân hệ Xưởng.](../../../../_images/work-order-card2.png)
