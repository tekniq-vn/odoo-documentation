...
![ECO with overview of stages in the top-right corner, and *Revision* smart button.](applications/inventory_and_mrp/plm/manage_changes/engineering_change_orders/eco-form.png)
...
![Find the tablet icon for each operation, second from the far right.](applications/inventory_and_mrp/plm/manage_changes/engineering_change_orders/tablet-icon.png)
...
![Open the *Add a Step* pop-up by clicking the three horizontal lines icon in tablet view.](applications/inventory_and_mrp/plm/manage_changes/engineering_change_orders/additional-options-menu.png)
...
!["Show Instructions" icon in the *Operations* tab of a BoM.](applications/inventory_and_mrp/plm/manage_changes/engineering_change_orders/show-instructions.png)
