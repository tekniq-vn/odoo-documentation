...
![Reverse transfer pop-up window on delivery order form.](repair_orders/repair-orders-reverse-transfer.png)
...
![Left-hand side of blank repair order form.](repair_orders/repair-orders-left-hand-form.png)
...
![Right-hand side of blank repair order form.](repair_orders/repair-orders-completed-repair-form.png)
...
![Type column options or new part under Parts tab.](repair_orders/repair-orders-type-column.png)
...
![Optional additional options to add to new part line.](repair_orders/repair-orders-additional-options.png)
...
![Uncomplete Moves pop-up window for unused parts.](repair_orders/repair-orders-uncomplete-moves.png)
...
![Moves history of product included in the repair order.](repair_orders/repair-orders-product-moves.png)
...
![Pre-populated new quotation for parts included in repair order.](repair_orders/repair-orders-new-quotation.png)
