...
The Odoo _Email Marketing_ app provides drag-and-drop design tools, pre-built templates, and other\
interactive features to create engaging email campaigns. The _Email Marketing_ app also provides|\
...
![View of the main dashboard of the Odoo Email Marketing application.](../../_images/mailings-dashboard.png)
...
* [List](email_marketing.md#email-marketing-list-view) (default view)
* [Kanban](email_marketing.md#email-marketing-kanban-view)
* [Lịch](email_marketing.md#email-marketing-calendar-view)
* [Biểu đồ](email_marketing.md#email-marketing-graph-view)
...
![Kanban view of the main dashboard of the Odoo Email Marketing application.](../../_images/kanban-view.png)
...
![View of the three-dot drop-down menu on the Odoo Email Marketing dashboard.](../../_images/three-dot-dropdown.png)
...
![Calendar view of the mailings dashboard in the Email Marketing application.](../../_images/calendar-view.png)
...
![How the Graph view appears in the Odoo Email Marketing application.](../../_images/graph-view.png)
...
button, if the _Documents_ application is installed. When clicked, a pop-up window appears, in which\
...
![The drop-down mega menu of search options the Odoo Email Marketing application.](../../_images/search-mega-menu.png)
...
![View of filters drop-down menu options on the Odoo Email Marketing dashboard.](../../_images/filters-dropdown.png)
...
![Add custom filter pop-up window that appears in Odoo Email Marketing app.](../../_images/add-custom-filter-popup.png)
...
![View of the Group By drop-down menu on the Odoo Email Marketing application.](../../_images/group-by-dropdown.png)
...
![View of the Favorites drop-down menu on the Odoo Email Marketing application.](../../_images/favorites-dropdown.png)
...
To view and modify the _Email Marketing_ settings, navigate to Email Marketing app\
‣ Configuration ‣ Settings.

![View of the Configuration menu with Settings page in the Odoo Email Marketing application.](../../_images/configuration-settings.png)

On the Settings page, there are four features available.

![View of the Settings page in the Odoo Email Marketing application.](../../_images/settings1.png)
...
![View of a blank email detail form in Odoo Email Marketing application.](../../_images/blank-email-detail-form.png)

On the email form, there are fields for the [Subject](email_marketing.md#email-marketing-subject) and[Recipients](email_marketing.md#email-marketing-recipients) of the email.

Beneath that, there are three tabs: [Mail Body](email_marketing.md#email-marketing-mail-body), [A/B Tests](email_marketing.md#email-marketing-ab-tests), and [Settings](email_marketing.md#email-marketing-settings-tab).
...
![View of recipients drop-down menu in the Odoo Email Marketing application.](../../_images/recipients-dropdown.png)
...
* Contact: ties specifically to the _Contacts_ app, and includes all the contacts\
  entered in the database.
* Event Registration: ties specifically to the _Events_ app, and provides opportunities\
...
* Lead/Opportunity: ties specifically to records in the _CRM_ application, which opens\
  up a number of opportunities to influence sales or purchase decisions.
* Liên hệ gửi thư: liên kết cụ thể với ứng dụng _Marketing qua Email_, tập trung vào các liên hệ gửi thư đã được nhập trong ứng dụng đó và liên quan đến danh sách liên hệ cụ thể. Các liên hệ này cũng đặc biệt vì chúng _không_ có thẻ liên hệ riêng trong ứng dụng _Liên hệ_. Bạn có thể truy cập danh sách này bằng cách đi đến Ứng dụng Marketing qua Email ‣ Danh sách liên hệ ‣ Liên hệ danh sách liên hệ.
* Sales Order: ties specifically to the _Sales_ app, and focuses on a specific sales\
...
![View of how recipient filters can be customized in Odoo Email Marketing.](../../_images/filter-records.png)
...
![View of the templates in the Mail Body tab in Odoo Email Marketing application.](../../_images/mail-body-templates.png)
...
![View of the building blocks in the Mail Body tab in Odoo Email Marketing application.](../../_images/template-building-blocks.png)
...
The Send Final On field allows users to choose a date that is used to know _when_ Odoo\
should determine the "winning" email, and subsequently, send that version of the email to the\
remaining recipients.

![View of the A/B Tests tab in Odoo Email Marketing application.](../../_images/ab-test-tab.png)
...
The options available in the Settings tab vary depending on if the _Mailing_\
_Campaigns_ feature is activated in Email Marketing ‣ Configuration ‣\
Settings. See [Mailing campaigns](email_marketing.md#email-marketing-mailing-campaigns) for more information.

Without the _Mailing Campaigns_ feature activated, the Settings tab on the email form\
only contains the Preview Text, Send From, Reply To,\
Attachments, and Responsible fields.

![View of settings tab in Odoo Email Marketing app, without campaign setting activated.](../../_images/settings-without-features.png)
...
If the _Mailing Campaign_ feature _is_ activated, an additional Campaign field\
appears in the Tracking section of the Settings tab.

![View of settings tab in Odoo Email Marketing when campaign setting is activated.](../../_images/settings-tab-with-campaign.png)
...
upper-left corner of the email form: [Send](email_marketing.md#email-marketing-send), [Schedule](email_marketing.md#email-marketing-schedule), and [Test](email_marketing.md#email-marketing-test).

### Gửi

The Send button reveals a Ready to unleash emails? pop-up window.

![View of pop-up window that appears when the send button on an email form is clicked.](../../_images/send-popup.png)
...
![View of pop-up window that appears when the schedule button on an email form is clicked.](../../_images/schedule-popup.png)

In this pop-up window, click the Send on field to reveal a calendar pop-up window.

![View of pop-up window that appears when the schedule button on an email form is clicked.](../../_images/schedule-popup-calendar.png)
...
![View of pop-up window that appears when the test button on an email form is clicked.](../../_images/test-popup.png)
...
In order to create and customize mailing campaigns, the _Mailing Campaigns_ feature **must** be\
activated in the _Settings_ page of the _Email Marketing_ application. To do that, navigate to\
Email Marketing app ‣ Configuration ‣ Settings, tick the box beside\
Mailing Campaigns, and click the Save button.

![View of the campaign feature setting in Odoo Email Marketing.](../../_images/campaigns-feature.png)
...
![View of the campaign page in Odoo Email Marketing.](../../_images/campaigns-page.png)
...
There are two different ways to create and customize campaigns in the _Email Marketing_ application,\
either directly from the [Campaigns page](email_marketing.md#email-marketing-campaign-page) or through the[Settings tab](email_marketing.md#email-marketing-campaign-settings) on an email form.

### Create mailing campaign (from campaigns page)

When the _Mailing Campaigns_ feature is activated, a new _Campaigns_ option appears in the header of\
the _Email Marketing_ application. Campaigns can be created directly on the _Campaigns_ page in th&#x65;_&#x45;mail Marketing_ app.
...
![View of the campaign pop-up kanban in Odoo Email Marketing.](../../_images/campaigns-kanban-popup.png)
...
![View of the campaign page in list view in Odoo Email Marketing.](../../_images/campaign-page-list-view.png)
...
![View of the blank campaign form in Odoo Email Marketing.](../../_images/blank-campaign-form.png)
...
![View of the campaign form in Odoo Email Marketing.](../../_images/campaign-form.png)
...
![View of the mailing campaign creation in the Settings tab of an email form.](../../_images/mailing-campaign-settings.png)
...
![View of the email mailing campaign pop-up window in Odoo Email Marketing application.](../../_images/mailing-campaign-popup.png)
