...
_Marketing_ applications **must** be [installed](../../general/apps_modules.md#general-install) and configured.
...
![A custom filter rule setting the time period to be anything before today's date.](../../../_images/created-on1.png)
...
![The statement at the top of the filters list, with the drop-down menu open.](../../../_images/match-all.png)
...
![Include multiple Stages in the filtering rule, using the "is in" operator.](../../../_images/stage-is-in.png)
...
![A list of filter rules that exclude all lost reasons other than the desired reason.](../../../_images/reasons.png)
...
![A pair of Match Any Of filter rules that include both active and inactive leads.](../../../_images/active.png)
...
Start From Scratch options for more granular control. For more information, refer to th&#x65;_&#x45;mail Marketing_ [documentation on how to create an email](../email_marketing.md#email-marketing-create-email).
...
If an existing _Lost Reason_ is not applicable, users with the necessary permissions can create new\
ones, which means the lost reasons in a database can vary from organization to organization, and\
from pipeline to pipeline.

For more information on _Lost Reasons_, including the creation of them, refer to[Manage lost opportunities](../../sales/crm/pipeline/lost_opportunities.md).
...
![The Mailing page of a sent email showing the smart buttons along the top of the page.](../../../_images/smart-buttons.png)
