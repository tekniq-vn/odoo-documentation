...
![Overview of events setting with the kanban view in Odoo Events.](../../_images/kanban-dashboard.png)
...
![Typical blank kanban card to fill out in the Odoo Events application.](../../_images/blank-kanban-card.png)
...
![The Events section on the Odoo Events settings page in the Odoo Events application.](../../_images/settings-events-section.png)
...
![The Registration section in the Odoo Events settings page in the Odoo Events application.](../../_images/settings-registration-section.png)
...
![The Attendance section in the Odoo Events Settings page in the Odoo Events application.](../../_images/settings-attendance-section.png)
