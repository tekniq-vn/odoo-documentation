...
#### SEE ALSO
[Event templates](event_templates.md)
...
#### SEE ALSO
[Bàn đăng ký](registration_desk.md)
...
#### SEE ALSO
[Revenues report](revenues_report.md)

* [Create events](create_events.md)
  * [New event](create_events.md#new-event)
  * [Event form](create_events.md#event-form)
    * [Tickets tab](create_events.md#tickets-tab)
    * [Communication tab](create_events.md#communication-tab)
      * [Mail](create_events.md#mail)
    * [Questions tab](create_events.md#questions-tab)
    * [Tab Ghi chú](create_events.md#notes-tab)
  * [Publish events](create_events.md#publish-events)
  * [Send event invites](create_events.md#send-event-invites)
* [Sell event tickets](sell_tickets.md)
  * [Cấu hình](sell_tickets.md#configuration)
  * [Sell event tickets with the Sales app](sell_tickets.md#sell-event-tickets-with-the-sales-app)
  * [Sell event tickets through the Website app](sell_tickets.md#sell-event-tickets-through-the-website-app)
* [Talks, proposals, and agenda](track_manage_talks.md)
  * [Event website](track_manage_talks.md#event-website)
    * [Talks page](track_manage_talks.md#talks-page)
    * [Talk Proposals page](track_manage_talks.md#talk-proposals-page)
    * [Agenda page](track_manage_talks.md#agenda-page)
* [Event templates](event_templates.md)
  * [Event templates page](event_templates.md#event-templates-page)
  * [Create event template](event_templates.md#create-event-template)
    * [Event template form](event_templates.md#event-template-form)
      * [Tab gian hàng](event_templates.md#booths-tab)
  * [Use event templates](event_templates.md#use-event-templates)
* [Event booths](event_booths.md)
  * [Cấu hình](event_booths.md#configuration)
  * [Booth categories](event_booths.md#booth-categories)
    * [Create booth category](event_booths.md#create-booth-category)
  * [Add booth to an event](event_booths.md#add-booth-to-an-event)
    * [Booth form](event_booths.md#booth-form)
  * [Sell event booths](event_booths.md#sell-event-booths)
* [Event tracks](event_tracks.md)
  * [Cấu hình](event_tracks.md#configuration)
  * [Event Tracks page](event_tracks.md#event-tracks-page)
    * [Create event track](event_tracks.md#create-event-track)
      * [Tab diễn giả](event_tracks.md#speaker-tab)
        * [Contact Details section](event_tracks.md#contact-details-section)
        * [Speaker Bio section](event_tracks.md#speaker-bio-section)
      * [Tab mô tả](event_tracks.md#description-tab)
      * [Interactivity tab](event_tracks.md#interactivity-tab)
      * [Add Quiz button](event_tracks.md#add-quiz-button)
  * [Publish event track](event_tracks.md#publish-event-track)
* [Bàn đăng ký](registration_desk.md)
  * [Registration Desk page](registration_desk.md#registration-desk-page)
  * [Quét huy hiệu](registration_desk.md#scan-a-badge)
  * [Select attendee](registration_desk.md#select-attendee)
* [Revenues report](revenues_report.md)
  * [Revenues reporting page](revenues_report.md#revenues-reporting-page)
    * [Đơn vị tính](revenues_report.md#measures)
    * [Filters and grouping options](revenues_report.md#filters-and-grouping-options)
      * [Filter options](revenues_report.md#filter-options)
      * [Group By options](revenues_report.md#group-by-options)
  * [Sample report: event ticket analysis (graph)](revenues_report.md#sample-report-event-ticket-analysis-graph)
  * [Sample report: event type analysis (pivot table)](revenues_report.md#sample-report-event-type-analysis-pivot-table)
