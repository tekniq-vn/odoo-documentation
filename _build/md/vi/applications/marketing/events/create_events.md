...
To learn more about website design functionality and options, consult the [Building block](../../websites/website/web_design/building_blocks/) documentation.
...
customize emails like this, refer to the [Create an email](../email_marketing/#email-marketing-create-email)
documentation.
