...
![The Schedule and Tracks setting in the Odoo Events app, along with corresponding options.](applications/marketing/events/event_tracks/track-settings.png)
...
![Typical event tracks page for an event in the Odoo Events application.](applications/marketing/events/event_tracks/event-tracks-page.png)
...
![Typical event track form in the Odoo Events application.](applications/marketing/events/event_tracks/event-track-form.png)
...
![The Speaker tab on an event track form in the Odoo Events application.](applications/marketing/events/event_tracks/speaker-tab.png)
...
![The Interactivity tab on an event track form in the Odoo Events application.](applications/marketing/events/event_tracks/interactivity-tab.png)
...
![The Add Quiz page in the Odoo Events application for an event track.](applications/marketing/events/event_tracks/add-quiz.png)
...
![The Create Questions pop-up window on an event-specific track quiz in the Odoo Events app.](applications/marketing/events/event_tracks/create-questions.png)
...
![The track-related event submenu options on an event website built with Odoo Events.](applications/marketing/events/event_tracks/published-toggle.png)
