...
![Launch a test button on a campaign detail form in Odoo Marketing Automation.](applications/marketing/marketing_automation/testing_running/launch-test.png)

When clicked, a Launch a test pop-up window appears.

![Launch a test pop-up window that appears in Odoo Markting Automation.](applications/marketing/marketing_automation/testing_running/launch-test-popup-window.png)
...
![Typing in a new contact directly from the launch a test pop-up window in Odoo.](applications/marketing/marketing_automation/testing_running/new-contact-from-launch-test-popup.png)
...
![A blank contact form from a launch test pop-up window in Odoo Marketing Automation.](applications/marketing/marketing_automation/testing_running/blank-contact-form.png)
...
![Test screen in Odoo Marketing Automation.](applications/marketing/marketing_automation/testing_running/test-screen.png)
...
![Workflow test progress in Odoo Marketing Automation.](applications/marketing/marketing_automation/testing_running/workflow-test-progress.png)
...
![The status of a marketing campaign changing to running in the upper-right corner.](applications/marketing/marketing_automation/testing_running/campaign-running-status.png)
...
![The workflow has been modified warning pop-up window of a marketing campaign form.](applications/marketing/marketing_automation/testing_running/workflow-modification-warning.png)
...
![The row of smart buttons that appear in a currently running marketing campaign in Odoo.](applications/marketing/marketing_automation/testing_running/campaign-smart-buttons.png)
...
![The stop button on a typical campaign detail form in Odoo Marketing Automation application.](applications/marketing/marketing_automation/testing_running/stop-button-campaign-form.png)
...
![Marketing campaign's stopped status on a campaign detail form in Odoo Marketing Automation.](applications/marketing/marketing_automation/testing_running/campaign-stopped-status-bar.png)
