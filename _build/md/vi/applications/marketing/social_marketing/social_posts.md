...
![Kanban view of the posts page in the Odoo Social Marketing application.](applications/marketing/social_marketing/social_posts/posts-page-kanban.png)
...
![Example of the calendar view in Odoo Social Marketing.](applications/marketing/social_marketing/social_posts/calendar-view.png)
...
![View of the list option on the posts page in Odoo Social Marketing.](applications/marketing/social_marketing/social_posts/list-view.png)
...
![View of the pivot option on the posts page in Odoo Social Marketing.](applications/marketing/social_marketing/social_posts/pivot-view.png)
...
![Sample of a social media post's pop-up window in Odoo Social Marketing application.](applications/marketing/social_marketing/social_posts/social-post-popup.png)
...
![The drop-down menu beside a comment revealing the option to create a lead.](applications/marketing/social_marketing/social_posts/create-lead-drop-down.png)

Upon clicking Create Lead from the comment's drop-down menu, a Conver Post to
Lead pop-up window appears.

![The convert post to lead pop-up window that appears in Odoo Social Marketing.](applications/marketing/social_marketing/social_posts/convert-post-to-lead-popup.png)
...
![New lead detail form generated from a social media comment in Odoo Social Marketing.](applications/marketing/social_marketing/social_posts/new-lead-detail-form-comments.png)
...
![Visual of how the Insights link appears on the dashboard of the Social Marketing app.](applications/marketing/social_marketing/social_posts/social-marketing-insights-link.png)
...
![New Post button on the main dashboard of the Odoo Social Marketing application.](applications/marketing/social_marketing/social_posts/new-post-button-social-marketing-dashboard.png)

Or, navigate to Social Marketing app ‣ Posts and click the New
button.

![New button on the Social Posts page in the Odoo Social Marketing application.](applications/marketing/social_marketing/social_posts/new-button-social-posts-page.png)

Either route reveals a blank social media post detail form that can be customized and configured in
a number of different ways.

![Blank social media post detail page in Odoo Social Marketing.](applications/marketing/social_marketing/social_posts/blank-post-detail-page.png)
...
![Sample social media post with visual samples of how it will appear on social media outlets.](applications/marketing/social_marketing/social_posts/visual-samples-social-media-outlets-preview.png)
...
![Visualized samples of post with newly-attached images in Odoo Social Marketing.](applications/marketing/social_marketing/social_posts/attach-images-visual-social-post-sample.png)
...
![Drop-down menu options of Create or Create and edit in the Campaign field.](applications/marketing/social_marketing/social_posts/campaign-drop-down-menu-options.png)
...
![Create campaign pop-up window that appears on a social media post detail form.](applications/marketing/social_marketing/social_posts/create-campaign-popup.png)
...
![Schedule date pop-up window that appears on social media post detail form in Odoo.](applications/marketing/social_marketing/social_posts/schedule-post-calendar-popup.png)
...
![Push notification options section on a social media post detail form.](applications/marketing/social_marketing/social_posts/push-notification-options-section.png)
...
![The Local Time option in the Push Notification Options section of features.](applications/marketing/social_marketing/social_posts/push-notification-local-time.png)
...
![Push notification conditions set up to match a specific amount of records in the database.](applications/marketing/social_marketing/social_posts/push-notification-condition.png)
