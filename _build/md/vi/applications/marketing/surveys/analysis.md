...
![The 'See Results' button present on the main dashboard of the Odoo Surveys application.](applications/marketing/surveys/analysis/see-results-button.png)
...
![Typical survey results page when 'See results' is clicked from the Odoo Surveys dashboard.](applications/marketing/surveys/analysis/results-page.png)
...
![The 'All surveys' drop-down menu opened on the 'See results' page of the Odoo Surveys app.](applications/marketing/surveys/analysis/all-surveys-dropdown.png)
...
![The 'Passed and Failed' drop-down menu on the 'See results' page of the Odoo Surveys app.](applications/marketing/surveys/analysis/passed-failed-dropdown.png)
...
![The 'Results Overview' section on the 'See results' page in the Odoo Surveys application.](applications/marketing/surveys/analysis/results-overview.png)
...
![The Responded and Skipped indicators on the 'See results' page in Odoo Surveys.](applications/marketing/surveys/analysis/responded-skipped-indicators.png)
...
![Sample of a 'correct' indicator on the 'See results' page in the Odoo Surveys application.](applications/marketing/surveys/analysis/correct-indicator.png)
...
![Typical pie graph results on the 'See results' page in the Odoo Surveys application.](applications/marketing/surveys/analysis/pie-graph-results.png)
...
![Typical bar graph results on the 'See results' page in the Odoo Surveys application.](applications/marketing/surveys/analysis/bar-graph-results.png)
...
![Typical 'Data' tab on the 'See results' page in the Odoo Surveys application.](applications/marketing/surveys/analysis/data-tab.png)
...
![Typical 'Most Common' tab on the 'See results' page in the Odoo Surveys application.](applications/marketing/surveys/analysis/most-common-tab.png)

The All Data tab shows a list of all the submitted responses to that particular
question.

![Typical 'All Data' tab on the 'See results' page in the Odoo Surveys application.](applications/marketing/surveys/analysis/all-data-tab.png)
...
![The Maximum, Minimum, and Average indicators on the 'See results' page in Odoo Surveys.](applications/marketing/surveys/analysis/max-min-avg-indicator.png)
...
![Typical 'Filter' icon on the 'See results' page in the Odoo Surveys application.](applications/marketing/surveys/analysis/filter-icon.png)
...
![The applied filter on the 'See results' page in the Odoo Surveys application.](applications/marketing/surveys/analysis/applied-filter.png)
...
![The Participations smart button at the top of a survey form in Odoo Surveys.](applications/marketing/surveys/analysis/participations-smart-button.png)
...
![The Participations page for a singular survey in the Odoo Surveys application.](applications/marketing/surveys/analysis/participations-page-singular-survey.png)
...
![An individual participant's detail form in the Odoo Surveys application.](applications/marketing/surveys/analysis/individual-participant-page.png)
...
![The Participations page for all surveys in the Odoo Surveys application.](applications/marketing/surveys/analysis/participations-page-all-surveys.png)
...
![The Participations page in the Kanban view in the Odoo Surveys application.](applications/marketing/surveys/analysis/participations-page-kanban-view.png)
