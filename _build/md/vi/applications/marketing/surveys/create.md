...
![How a blank survey form looks in the Odoo Surveys application.](applications/marketing/surveys/create/blank-survey-form.png)
...
![The slider drop-down menu with the Mandatory Answer option selected in Odoo Surveys.](applications/marketing/surveys/create/mandatory-answer-dropdown.png)
...
![The Questions section of the Options tab on a survey form in Odoo Surveys.](applications/marketing/surveys/create/questions-section-options-tab.png)
...
![The Time and Scoring section of the Options tab on a survey form in Odoo Surveys.](applications/marketing/surveys/create/time-scoring-section-options-tab.png)
...
![The Participants section of the Options tab on a survey form in Odoo Surveys.](applications/marketing/surveys/create/participants-section-options-tab.png)
...
![The Live Session section of the Options tab on a survey form in Odoo Surveys.](applications/marketing/surveys/create/live-session-section-options-tab.png)
...
![The various buttons on a survey form in Odoo Surveys.](applications/marketing/surveys/create/survey-form-buttons.png)
...
- Share: click to reveal a Share a Survey pop-up form that can be used to
  ...
  ![The 'Share a Survey' pop-up window that appears in the Odoo Surveys application.](applications/marketing/surveys/create/share-survey-popup.png)
  ...
  ![The 'Share a Survey' pop-up window in Odoo Surveys with the Send by Email toggled on.](applications/marketing/surveys/create/share-survey-popup-email-toggle.png)
