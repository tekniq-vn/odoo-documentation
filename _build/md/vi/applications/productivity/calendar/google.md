...
![Create a new API project to store credentials.](applications/productivity/calendar/google/new-api-project.png)
...
![Enable APIs and Services on the API Project.](applications/productivity/calendar/google/enable-apis-services.png)
...
![Enable the Google Calendar API.](applications/productivity/calendar/google/enable-google-cal-api.png)
...
![Add the authorized JavaScript origins and the authorized redirect URIs.](applications/productivity/calendar/google/uri.png)
...
![The Google Calendar checkbox in General Settings.](applications/productivity/calendar/google/settings-google-cal.png)
...
![Click the Google sync button in Odoo Calendar to sync Google Calendar with Odoo.](applications/productivity/calendar/google/sync-google.png)
...
![Give Odoo permission to access Google Calendar.](applications/productivity/calendar/google/trust-odoo.png)
...
![Reset buttons highlighted on the calendar tab of the user.](applications/productivity/calendar/google/google-reset.png)
...
![Google calendar reset options in Odoo.](applications/productivity/calendar/google/reset-calendar.png)
...
![403 Access Denied Error.](applications/productivity/calendar/google/403-error.png)
...
![Error 400 Redirect URI Mismatch.](applications/productivity/calendar/google/error-400.png)
