...
![A close up of a chatter thread of an OdooBot created contact record.](applications/productivity/discuss/chatter/odoo-bot-created.png)
...
![The Edit Subscription window on a Helpdesk ticket.](applications/productivity/discuss/chatter/chatter-edit-subscription.png)
...
the customer listed on the opportunity record.](applications/productivity/discuss/chatter/send-message-followers.png)
...
![A chatter composer with emphasis on the expand icon.](applications/productivity/discuss/chatter/chatter-expand-icon.png)
...
![The expanded full chatter composer in the CRM application.](applications/productivity/discuss/chatter/chatter-full-composer.png)
...
![The edit message option in a chatter thread.](applications/productivity/discuss/chatter/chatter-edit.png)
...
![Search results in a chatter thread emphasising the search icon and the jump button.](applications/productivity/discuss/chatter/chatter-search.png)
...
![A chatter thread with planned activities with varying due dates.](applications/productivity/discuss/chatter/chatter-activity-icons.png)
...
![A chatter thread with a completed activity, included additional details.](applications/productivity/discuss/chatter/chatter-completed-activity.png)
...
![A chatter thread with a file attached and the Attach files button added.](applications/productivity/discuss/chatter/chatter-attach-files.png)
...
![A send WhatsApp message pop-up window.](applications/productivity/discuss/chatter/whats-app-message.png)
...
![alt text](applications/productivity/discuss/chatter/chatter-translate-message.png)
