...
![Trạng thái chữ ký](applications/productivity/sign/signature-status.png)
...
![Add a hash to your document](applications/productivity/sign/sms-verification.png)
...
![select customer identified with itsme®](applications/productivity/sign/itsme-identification.png)
...
![Adding the visual security frame to a signature.](applications/productivity/sign/sign-hash.png)
...
![Toggle the switch to specify the signing order.](applications/productivity/sign/specify-signing-order.png)
...
![Tip and placeholder example in Odoo Sign](applications/productivity/sign/tip-placeholder.png)
