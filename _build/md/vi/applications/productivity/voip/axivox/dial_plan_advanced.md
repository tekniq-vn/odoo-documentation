...
![Visual editor for a dial plan in Axivox, with Add and the dispatcher element highlighted.](applications/productivity/voip/axivox/dial_plan_advanced/visual-editor.png)
...
![Dispatcher configuration panel, with name, regular expression and add a line highlighted.](applications/productivity/voip/axivox/dial_plan_advanced/dispatcher.png)
...
![Dial plan with dispatcher element highlighted.](applications/productivity/voip/axivox/dial_plan_advanced/dispatcher-element.png)
...
![Time condition element set in a dial plan on Axivox. Time condition is highlighted.](applications/productivity/voip/axivox/dial_plan_advanced/time-condition.png)

#### IMPORTANT
To set the Timezone that the Time Condition operates under, navigate to
[Axivox management console](https://manage.axivox.com), and click Settings in the
...
![Access list element configuration with the allow/deny fields highlighted.](applications/productivity/voip/axivox/dial_plan_advanced/access-config.png)
...
![Access list element highlighted in an example dial plan.](applications/productivity/voip/axivox/dial_plan_advanced/access-list.png)
...
![Switch configuration in a dial plan, with inactive and active routes highlighted.](applications/productivity/voip/axivox/dial_plan_advanced/switch.png)
...
![Multi-switch configuration in a dial plan, with chosen route highlighted.](applications/productivity/voip/axivox/dial_plan_advanced/multi-switch.png)
