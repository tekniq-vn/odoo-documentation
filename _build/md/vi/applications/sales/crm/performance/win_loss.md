...
2. On the Pipeline Analysis page, click the ⬇️ (down arrow) icon, next to\
   the search bar, to open a drop-down menu of filters and groupings.![The Search menu containing the filters for a basic win/loss report.](../../../../_images/filters-for-basic-win-loss-report.png)
...
> <img src="../../../../_images/pivot-view-in-spreadsheet.png" alt="Pivot View reports especially benefit from being inserted in spreadsheets." data-size="original">
