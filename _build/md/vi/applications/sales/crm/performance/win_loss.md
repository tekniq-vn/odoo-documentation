...
![Open the CRM app and click on the Reporting tab along the top, then click Pipeline.](win_loss/reporting-tab-and-pipeline-view.png)
...
![The default state of the Pipeline Analysis page is a graph, with many options to change it.](win_loss/pipeline-analysis-page.png)
...
![Clicking on the down arrow next to the search bar opens a menu of filters for the analysis.](win_loss/search-panel-filters-and-group-by-options.png)
...
![The add branch feature allows the creation of more complex all or any statements for rules.](win_loss/custom-filter-add-branch.png)
...
![The Graph View displays the analysis as a Bar Chart, Line Chart, or Pie Chart.](win_loss/graph-view.png)
...
![The Pivot View displays the analysis as a table.](win_loss/pivot-view.png)
...
![The Cohort View displays the analysis as individual weeks of the year.](win_loss/cohort-view.png)
...
![The List View displays a single list of all records matching the search criteria.](win_loss/list-view.png)
...
![The search criteria for win/loss reports is Created On, Stage, and Active is in true false.](win_loss/search-criteria-for-basic-win-loss.png)
...
2. On the Pipeline Analysis page, click the ⬇️ (down arrow) icon, next to
   ...
   ![The Search menu containing the filters for a basic win/loss report.](win_loss/filters-for-basic-win-loss-report.png)
...
![The Add Custom Filter menu showing two rules: (1) Active is set, and (2) Active is not set.](win_loss/add-custom-active-filter.png)
...
![A basic win/loss report showing all leads whether won or lost grouped by stage.](win_loss/basic-win-loss-report.png)
...
![The Search menu open and the Won and Lost filters highlighted.](win_loss/search-panel-filters-and-group-by-options.png)
...
![A win/loss report in Pivot View displays the data in table form.](win_loss/win-loss-pivot-view.png)
...
![A win/loss report in List View displays all leads in an easy-to-read list.](win_loss/win-loss-list-view.png)
...
![Under the Favorites heading, click Save current search and save the report for later.](win_loss/save-to-favorites.png)
...
> ![Pivot View reports especially benefit from being inserted in spreadsheets.](win_loss/pivot-view-in-spreadsheet.png)
...
![To access the saved report, open the Dashboard app and click My Dashboard.](win_loss/add-to-dashboard.png)
