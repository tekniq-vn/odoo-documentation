...
![Open the CRM app and click on the Reporting tab at the top of the page, then click Leads.](applications/sales/crm/track_leads/marketing_attribution/reporting-tab-and-leads.png)
...
![Click the button with four horizontal lines on the top right of the Leads Analysis page.](applications/sales/crm/track_leads/marketing_attribution/list-view-button.png)
...
![Select any number of filters and groups in the search options.](applications/sales/crm/track_leads/marketing_attribution/search-results-multiple-options.png)
...
![Set the name, number of records, and location of the export in the option menu.](applications/sales/crm/track_leads/marketing_attribution/documents-export.png)
