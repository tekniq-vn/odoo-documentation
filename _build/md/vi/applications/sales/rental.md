...
![Example of the Rental Orders dashboard available in the Odoo Rental application.](applications/sales/rental/rental-orders-dashboard.png)
...
![How the Settings page appears in the Odoo Rental application.](applications/sales/rental/rental-settings.png)
...
![How the Settings page appears in the Odoo Rental application.](applications/sales/rental/rental-prices-tab.png)
...
![Sample of a filled out rental order available in the Odoo Rental application.](applications/sales/rental/rental-order.png)
...
![Sample of a rental period calendar pop-up window in the Odoo Rental application.](applications/sales/rental/rental-period-field-popup.png)
...
![The update rental prices option that appears in the Odoo Rental application.](applications/sales/rental/rental-update-rental-prices.png)
...
![The Sign Documents pop-up window that appears in the Odoo Rental application.](applications/sales/rental/sign-documents-popup.png)
...
![The New Signature Request pop-up window that appears in the Odoo Rental application.](applications/sales/rental/new-signature-request-form.png)
...
![The adopt your signature pop-up window that appears in the Odoo Rental application.](applications/sales/rental/adopt-signature-popup.png)
...
![The validate and send completed document button in the Odoo Rental application.](applications/sales/rental/validate-send-doc-button.png)
...
![The pickup and return receipt print option in the Odoo Rental application.](applications/sales/rental/print-pickup-return-receipt.png)
