...
![An example on eBay of the variations that can be added to a product.](applications/sales/sales/ebay_connector/setup/ebay-variation.png)
...
![Item specifics listed on an eBay product.](applications/sales/sales/ebay_connector/setup/item-specifics.png)
...
- In Odoo, create and configure products that are intended to be listed in eBay. eBay does not
  ...
  - Odoo does not allow multiple eBay listings to be linked per product in Odoo. If the company
    ...
    ![Setting up bill of materials with base product and linked products.](applications/sales/sales/ebay_connector/setup/products-odoo.png)
...
![Generate a verification token in Odoo.](applications/sales/sales/ebay_connector/setup/generate-token.png)
...
![Disabled keyset present after creating a keyset.](applications/sales/sales/ebay_connector/setup/disabled-keyset.png)
...
![Configuring account deletion / notification settings in eBay.](applications/sales/sales/ebay_connector/setup/account-closure.png)
...
![Application keys are populated after creating the app in eBay.](applications/sales/sales/ebay_connector/setup/application-keys.png)
...
![Generate user token s on the eBay developer console.](applications/sales/sales/ebay_connector/setup/user-tokens.png)
...
![Generated user token and API explorer link on the eBay developer console.](applications/sales/sales/ebay_connector/setup/user-token.png)
