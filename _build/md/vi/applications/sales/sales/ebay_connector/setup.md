...
Odoo's eBay connector allows eBay listings to connect with Odoo products. Once connected,[updates to the listings](linking_listings.md) can be made in Odoo or in eBay. When an item sells\
...
The newly created _production keyset_ is disabled by default. Activate it by subscribing to the\
...
Clicking Agree allows eBay to link the eBay account with the _application programming_\
