...
![A create invoices pop-up form with down payment fields filled in with information.](down_payment/create-invoices-popup-form-filled-out.png)
...
![Down payment as a product in the invoice lines tab of a customer invoice draft in Odoo.](down_payment/down-payment-product-inv-draft.png)
...
![Down payment product form with service product type and invoicing policy field.](down_payment/down-payment-product.png)
