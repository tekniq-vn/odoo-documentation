...
![A sales order with the configured expense ready to be invoiced in the Order Lines tab.](applications/sales/sales/invoicing/expense/sales-order-with-expense-order-lines.png)
