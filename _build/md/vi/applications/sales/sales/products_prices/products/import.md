...
![The Import records option selectable from the gear icon on the Products page in Odoo Sales.](../../../../../_images/gear-import-records-option.png)
...
![The Import records option selectable from the gear icon on the Products page in Odoo Sales.](../../../../../_images/import-template-products.png)
...
*   Feel free to add new columns to the template spreadsheet, if desired. However, to be added, those\
    ...
    appropriate field from that drop-down menu.![The Odoo Field drop-down menu next to a Field Column that needs to be manually adjusted.](../../../../../_images/odoo-field-dropdown-menu.png)
...
![The upload file button on the import products template download page in Odoo Sales.](../../../../../_images/upload-file-button.png)
...
![The import a file page in Odoo Sales after a product template has been uploaded.](../../../../../_images/import-a-file-page.png)
...
![The everything seems valid message that appears if file columns are entered correctly.](../../../../../_images/everything-seems-valid-message.png)
...
![The import error message that appears if file columns don't match an Odoo Field.](../../../../../_images/import-error-message.png)
...
![The pop-up window that appears after a successful product import process in Odoo Sales.](../../../../../_images/successful-import-popup.png)
...
![An attributes and values spreadsheet template for imports.](../../../../../_images/attributes-and-values-spreadsheet.png)
...
![Product variants spreadsheet with product attributes and variants for import purposes.](../../../../../_images/product-attribute-spreadsheet-import.png)
