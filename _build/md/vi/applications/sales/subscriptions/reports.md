...
![The different view options available on the Subscriptions Analysis page.](reports/subscriptions-analysis-page-view-options.png)
...
![The different graph view options in the Odoo Subscriptions app.](reports/subscriptions-graph-specific-options.png)
...
![The pivot-specific view options available in the Odoo Subscriptions app.](reports/subscriptions-pivot-view-options.png)
...
![The standard measures drop-down menu in the Odoo Subscriptions app.](reports/subscriptions-measures-drop-down.png)
...
![The spreadsheet pop-up window of the Subscriptions Analysis page.](reports/subscriptions-analysis-spreadsheet-popup.png)
...
![The default view of the Subscriptions Analysis reporting page in Odoo Subscriptions.](reports/subscriptions-analysis-page-default.png)
...
![The measures drop-down menu of the Subscriptions Analysis page.](reports/subscriptions-analysis-measures.png)
...
![The default view of the Retention Analysis reporting page in Odoo Subscriptions.](reports/subscriptions-retention-analysis-page-default.png)
...
![The measures drop-down menu of the Retention Analysis page.](reports/subscriptions-retention-analysis-measures.png)
...
![The time period drop-down menu of the Retention Analysis page.](reports/subscriptions-retention-analysis-time-periods.png)
...
![The default appearance of the MRR Breakdown reporting page in Odoo Subscriptions.](reports/subscriptions-mrr-breakdown-default.png)

When the Measures drop-down menu on the MRR Breakdown reporting page is
clicked, a series of metric-related options become available.

![The default appearance of the MRR Breakdown reporting page in Odoo Subscriptions.](reports/subscriptions-mrr-breakdown-measures.png)
...
![The default appearance of the MRR Analysis reporting page in Odoo Subscriptions.](reports/subscriptions-mrr-analysis-default.png)

When the Measures drop-down menu on the MRR Analysis reporting page is
clicked, a series of metric-related options become available.

![The default appearance of the MRR Analysis reporting page in Odoo Subscriptions.](reports/subscriptions-mrr-analysis-measures.png)
