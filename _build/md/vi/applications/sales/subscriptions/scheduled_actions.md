...
![The scheduled actions option under the technical menu in the Odoo Settings application.](scheduled_actions/scheduled-actions-technical-settings-page.png)
...
![The subscription-related results on the scheduled actions page in Odoo Settings.](scheduled_actions/scheduled-actions-page-subscription-results.png)
...
![The scheduled action form in the Odoo Settings application.](scheduled_actions/scheduled-action-form.png)
...
![The necessary deferred account settings in the Odoo Accounting app's settings page.](scheduled_actions/deferred-settings-accounting.png)
...
![A confirmed subscription sales order in the Odoo Subscriptions application.](scheduled_actions/confirmed-subscription-sales-order-fields.png)
...
![The Payment Token field under the Other Info tab on a subscription sales order form.](scheduled_actions/payment-token-field.png)
...
![The expiration date on a subscription sales order in Odoo Subscriptions.](scheduled_actions/subscription-expiration-date.png)
...
![The Invoice Date column on subscriptions invoice page in Odoo Subscriptions app.](scheduled_actions/invoices-invoice-date-column.png)
...
![The Automatic Closing field on a Recurring Plan form in Odoo Subscriptions.](scheduled_actions/automatic-closing-field.png)
