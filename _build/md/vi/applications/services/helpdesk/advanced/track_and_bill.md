...
![View of a helpdesk team settings page emphasizing the track and bill time settings.](../../../../_images/track-bill-enable-settings.png)
...
![View of a service product with the invoicing policy set to 'Based on timesheets'.](../../../../_images/track-bill-product-based-on-timesheets.png)
...
![View of a service product with the invoicing policy set to 'prepaid/fixed'.](../../../../_images/track-bill-product-prepaid-fixed.png)
...
![View of the timesheets tab on a ticket with an emphasis on the remaining hours on an SO.](../../../../_images/track-bill-remaining-hours-total.png)
...
![View of the timesheets tab on a helpdesk ticket.](../../../../_images/track-bill-record-timesheet-hours.png)
...
![View of a sales order with emphasis on the delivered column.](../../../../_images/track-bill-delivered-timesheet-hours.png)
...
![View of create invoices pop up showing timesheets period fields.](../../../../_images/track-bill-create-invoice-timesheets-period.png)
