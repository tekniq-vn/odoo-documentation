...
Type `/` to open the _powerbox_, and view a drop-down list of [commands](applications/productivity/knowledge/articles_editing.md). Select or type `clipboard`. A gray block is\
