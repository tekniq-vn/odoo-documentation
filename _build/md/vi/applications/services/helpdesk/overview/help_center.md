...
![Overview of the settings page of a team emphasizing the Help Center features.](../../../../_images/help-center-enable-features.png)
...
![View of a message in Helpdesk focusing on the Knowledge bookmark icon.](../../../../_images/help-center-knowledge-bookmark-icon.png)
...
![View of knowledge search window from a helpdesk ticket.](../../../../_images/help-center-knowledge-search.png)
...
![View of a knowledge article focused on sharing and publishing options.](../../../../_images/help-center-knowledge-sharing.png)
...
Type `/` to open the _powerbox_, and view a drop-down list of [commands](../../../productivity/knowledge/articles_editing.md). Select or type `clipboard`. A gray block is\
then added to the page. Add any necessary content to this block.

![View of a clipboard in knowledge with focus on send and copy options.](../../../../_images/help-center-knowledge-clipboard-options.png)
...
Helpdesk app ‣ Configuration ‣ Helpdesk Teams and select a team, or create a[new one](../../helpdesk.md).
...
![Overview of the Forums page of a website to show the available ones in Odoo Helpdesk.](../../../../_images/help-center-share-on-forum.png)
...
![View of a course being published for Odoo Helpdesk.](../../../../_images/help-center-elearning-course-contents-page.png)
...
![View of a course contents being published in Odoo Helpdesk back-end.](../../../../_images/help-center-elearning-publish-back-end.png)
