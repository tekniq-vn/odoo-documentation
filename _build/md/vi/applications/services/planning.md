...
![Creating a new property field in Planning.](applications/services/planning/add-properties.png)
...
![Employee profile and the work information tab.](applications/services/planning/employee-tab.png)
...
![Shift form with the option `save template` ticked.](applications/services/planning/save-template.png)
...
![A schedule displaying various visual elements.](applications/services/planning/schedule.png)
