...
Nhấp Mới để tạo khóa học mới. Khi trang hiện ra, bạn có thể thêm Tiêu đề khóa học và một hoặc nhiều Thẻ để mô tả khóa học. Bạn có thể thêm hình ảnh minh họa bằng cách di chuột vào hình ảnh camera giữ chỗ và nhấp vào biểu tượng chỉnh sửa. Bốn tab cho phép bạn chỉnh sửa thêm khóa học: [Nội dung](elearning.md#elearning-content), [Mô tả](elearning.md#elearning-description), [Tùy chọn](elearning.md#elearning-options) và [Karma](elearning.md#elearning-karma).

![Create your elearning course.](../../.gitbook/assets/elearning-course-creation.png)

#### Content tab

This tab allows you to manage your course content. Click on Add Section to divide your\
course into different sections. Click on Add Content to create[content](elearning.md#elearning-create-content). Click on Add Certification to assess the\
...
![Add a description to your course.](../../.gitbook/assets/course-description.png)

#### Options tab

In the Options tab, different configurations are available:[Course](elearning.md#elearning-course), [Communication](elearning.md#elearning-communication),[Access rights](elearning.md#elearning-access-rights), and [Display](elearning.md#elearning-display).

![Overview of the Options tab](../../.gitbook/assets/options-tab.png)
...
New to create content. Add your Content Title, and if you want[Tags](elearning.md#elearning-tags), then fill in the related information among the different tabs.

![Create your content.](../../.gitbook/assets/elearning-content-tab.png)
...
![Additional ressources](../../.gitbook/assets/additional-content.png)
...
![Publish your content.](../../.gitbook/assets/elearning-publish-button.png)
