...
![View of the chat window with a helpdesk ticket created in Odoo Live Chat.](applications/websites/livechat/chatbots/chatbot-visitor-view.png)
...
![View of the Welcome Bot script in Odoo Live Chat.](applications/websites/livechat/chatbots/chatbot-welcome-bot.png)
...
![View of a chatbot responding to an invalid email.](applications/websites/livechat/chatbots/chatbot-invalid-email.png)
...
![View of a chatbot follow up messages when no live chat operator is available.](applications/websites/livechat/chatbots/chatbot-no-operator.png)
...
![View of the channel rules emphasizing the chatbot field.](applications/websites/livechat/chatbots/chatbot-add-to-channel.png)
