...
![When the grid layout is selected, choose an image and drag and drop it where needed.](applications/websites/website/web_design/building_blocks/grid-layout.png)
...
![Adjust the number of images per line on mobile view.](applications/websites/website/web_design/building_blocks/cols.png)
...
![Duplicating a building block](applications/websites/website/web_design/building_blocks/duplicate-container.png)
...
![Reordering building blocks](applications/websites/website/web_design/building_blocks/reordering-blocks.png)
...
![Saving a building block](applications/websites/website/web_design/building_blocks/saving-custom-block.png)
...
![Custom section with saved building blocks](applications/websites/website/web_design/building_blocks/custom-blocks.png)
...
![Click the "show/hide on mobile" icons to show or hide some elements on mobile.](applications/websites/website/web_design/building_blocks/show-hide-on-mobile.png)
