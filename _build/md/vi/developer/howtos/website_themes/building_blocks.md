...
![Example of text highlight](building_blocks/text-highlight.jpg)
```xml
<h2>
   Title with
...
![Add a subtitle between custom options](building_blocks/we-title.jpg)
...
![Add option choices and style them with some icons](building_blocks/we-button.jpg)
...
![Add a dropddown list field](building_blocks/we-select.jpg)
...
![Add a dropddown list field](building_blocks/we-button-group.jpg)
...
![Add a toggle switch.](building_blocks/we-checkbox.jpg)
...
![Add a toggle switch.](building_blocks/we-range.jpg)
...
![Add a text field.](building_blocks/we-input.jpg)
...
![Add a colorpicker.](building_blocks/we-colorpicker.jpg)
