...
The most common action type, used to present visualisations of a model through[views](developer/reference/user_interface/view_records.md): a window action defines a set of view types\
