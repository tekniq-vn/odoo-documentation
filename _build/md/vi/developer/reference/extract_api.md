...
document digitization account. More information about accounts can be found[here](../../applications/essentials/in_app_purchase.md).
...
You should use the [latest version available](extract_api.md#extract-api-version).\
`documents` (required)\
...
The supported formats are _pdf_, _png_ and _jpg_.\
`dbuuid` (optional)\
...
`user_lang` (optional)\
: The user language. Format: _language\_code + \_ + locale_ (e.g. fr\_FR, en\_US).\
`user_email` (optional)\
: The user email.\
`purchase_order_regex` (optional)\
: Regex for purchase order identification. Will default to Odoo PO format if not provided.\
`perspective` (optional)\
: Can be `client` or `supplier`. This field is useful for invoices only.`client` means that the user information provided are related to the client of the\
...
| `purchase_order`   | <p><code>content</code> is a string<br><br>Uses <code>selected_values</code> instead of <code>selected_value</code></p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
