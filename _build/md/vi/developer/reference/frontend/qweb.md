...
in which case templates stored in the database (as[views](../user_interface/view_architectures.md#reference-view-architectures-qweb)) can be trivially rendered by calling`odoo.http.HttpRequest.render()`:
