...
* The names of all fields present in the current view, containing the value of the current record,\
  except for `column_invisible` in [list view](view_architectures.md#reference-view-architectures-list-field);\
...
Form views accept the following children semantic components: [field](view_architectures.md#reference-view-architectures-form-field), [label](view_architectures.md#reference-view-architectures-form-label),[button](view_architectures.md#reference-view-architectures-form-button),[Chatter widget](view_architectures.md#reference-view-architectures-form-chatter), and[Attachments preview widget](view_architectures.md#reference-view-architectures-form-attachment).
...
The node id. Useful when there are several occurrences of the same field in the view (see[label: display field labels](view_architectures.md#reference-view-architectures-form-label)).
...
(e.g., `Char`, `Many2one`). See[Fields](../frontend/javascript_reference.md#reference-js-widgets).
...
* **Requirement:**\
  Optional
* **Type:**[Python expression](view_architectures.md#reference-view-architectures-python-expression)
* **Default:**`{}`
...
When a [field](view_architectures.md#reference-view-architectures-form-field) component is not placed directly\
inside a [group](view_architectures.md#reference-view-architectures-form-group), or when its `nolabel` attribute is\
...
its id (the `id` attribute set on the [field](view_architectures.md#reference-view-architectures-form-field)).
...
Form views accept the following children structural components: [group](view_architectures.md#reference-view-architectures-form-group), [sheet](view_architectures.md#reference-view-architectures-form-sheet),[notebook](view_architectures.md#reference-view-architectures-form-notebook),[notebook](view_architectures.md#reference-view-architectures-form-notebook),[newline](view_architectures.md#reference-view-architectures-form-newline),[separator](view_architectures.md#reference-view-architectures-form-separator),[header](view_architectures.md#reference-view-architectures-form-header),[footer](view_architectures.md#reference-view-architectures-form-footer),[Buttons container](view_architectures.md#reference-view-architectures-form-button-container), and[Title container](view_architectures.md#reference-view-architectures-form-title-container).
...
[field](view_architectures.md#reference-view-architectures-form-field) elements that are direct children of groups\
...
The `sheet` element can be used as a direct child of the [form](view_architectures.md#reference-view-architectures-form) root element for a narrower and more responsive form layout\
(centered page, margin...). It usually contains [group](view_architectures.md#reference-view-architectures-form-group) elements.
...
The `newline` element is used within [group](view_architectures.md#reference-view-architectures-form-group)\
...
The `header` element combined with the [sheet](view_architectures.md#reference-view-architectures-form-sheet)\
element provides a full-width location above the sheet itself generally used to display workflow[button](view_architectures.md#reference-view-architectures-form-button) elements and a [field](view_architectures.md#reference-view-architectures-form-field) element rendered as status widget.
...
The `footer` element is used to display [buttons](view_architectures.md#reference-view-architectures-form-button)\
...
A [button](view_architectures.md#reference-view-architectures-form-button) elements container can be created with a`div` element with the class `button_box`.
...
A title [field](view_architectures.md#reference-view-architectures-form-field) element container can be created with\
...
Settings views are a customization of the [form](view_architectures.md#reference-view-architectures-form) view. They\
...
Settings views accept the [field](view_architectures.md#reference-view-architectures-form-field), [label](view_architectures.md#reference-view-architectures-form-label) and [button](view_architectures.md#reference-view-architectures-form-button) elements of [form](view_architectures.md#reference-view-architectures-form) views, as well as three additional children elements:[app](view_architectures.md#reference-view-architectures-settings-app), [block](view_architectures.md#reference-view-architectures-settings-block), and [setting](view_architectures.md#reference-view-architectures-settings-setting).
...
The first [field](view_architectures.md#reference-view-architectures-form-field) element in the setting is used as\
...
given [field](view_architectures.md#reference-view-architectures-form-field). By defining `type="header"`, a\
...
The root element of list views is `tree`[<sup>1</sup>](view_architectures.md#treehistory).
...
The architecture for the inline [form](view_architectures.md#reference-view-architectures-form) view is derived\
...
List views accept the following children elements: [field](view_architectures.md#reference-view-architectures-list-field), [button](view_architectures.md#reference-view-architectures-list-button), [groupby](view_architectures.md#reference-view-architectures-list-groupby), [header](view_architectures.md#reference-view-architectures-list-header), [control, and create](view_architectures.md#reference-view-architectures-list-control).
...
The `groupby` element is used to define group headers with [button](view_architectures.md#reference-view-architectures-list-button) elements when grouping records on`Many2one` fields. It also accepts [field](view_architectures.md#reference-view-architectures-list-field) elements, which can be used for modifiers. These fields\
...
A special [button](view_architectures.md#reference-view-architectures-list-button) element with `type="edit"` can\
...
The `button` element allows defining buttons in the control panel. It is the same element as the[button element in list views](view_architectures.md#reference-view-architectures-list-button), but it accepts\
...
aggregated views; e.g., [List](view_architectures.md#reference-view-architectures-list) and[Graph](view_architectures.md#reference-view-architectures-graph)).
...
Search views accept the following children elements: [field](view_architectures.md#reference-view-architectures-search-field), [filter](view_architectures.md#reference-view-architectures-search-filter), [separator](view_architectures.md#reference-view-architectures-search-separator), [group](view_architectures.md#reference-view-architectures-search-group), and [searchpanel](view_architectures.md#reference-view-architectures-search-searchpanel).
...
The domain to use as the field's search domain, as a Python expression that evaluates to a[domain](../backend/orm.md#reference-orm-domains).
...
The technical name of the filter. It can be used to [enable it by default](view_architectures.md#reference-view-architectures-search-defaults) or as an [inheritance hook](view_records.md#reference-view-records-inheritance).
...
The `separator` element is used to separates groups of [filters](view_architectures.md#reference-view-architectures-search-filter) in simple search views. For more complex search views,\
the [group](view_architectures.md#reference-view-architectures-search-group) element is recommended.
...
The `group` element is used to separate groups of [filters](view_architectures.md#reference-view-architectures-search-filter) in cluttered search views. In simpler search views, it\
can be substituted for the [separator](view_architectures.md#reference-view-architectures-search-group) element.
...
visualisation: they display records as "cards", halfway between a [list](view_architectures.md#reference-view-architectures-list) view and a non-editable [form](view_architectures.md#reference-view-architectures-form) view.
...
The reference of the [form](view_architectures.md#reference-view-architectures-form) view to open when using the\
...
Kanban views accept the following children elements: [field](view_architectures.md#reference-view-architectures-kanban-field), [header](view_architectures.md#reference-view-architectures-kanban-header), [progressbar](view_architectures.md#reference-view-architectures-kanban-progressbar), and [templates](view_architectures.md#reference-view-architectures-kanban-templates).

Placeholders are denoted in all caps.

#### `field`: display field values

The `field` element declares fields to use in the [templates](view_architectures.md#reference-view-architectures-kanban-templates). If the field is simply displayed, it does not need\
to be pre-declared.
...
The `header` element accepts only `button` children elements, similar to [list views' button](view_architectures.md#reference-view-architectures-list-button) elements.
...
*   Buttons and links with a `type` attribute perform different operations than their standard HTML\
    function. The `type` attribute can have the values `action` and `object` of [regular buttons](view_architectures.md#reference-view-architectures-list-button), or the following values:
...
QWeb views are standard [QWeb Templates](../frontend/qweb.md#reference-qweb) templates inside a view's`arch`. They don't have a specific root element. Because QWeb views don't\
...
* they can be used as frontend templates, in which case[template](../backend/data.md#reference-data-template) should be used as a shortcut.
...
types the columns. The first cell of each row displays a (customizable, see`templates`, quite similarly to [Kanban](view_architectures.md#reference-view-architectures-kanban)) card representing\
...
split into multiple templates for clarity, but activity views _must_ define at\
...
(see [Kanban](view_architectures.md#reference-view-architectures-kanban) for more details):\
`widget`\
