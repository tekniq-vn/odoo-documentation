...
(e.g., `Char`, `Many2one`). See[Fields](developer/reference/frontend/javascript_reference.md#reference-js-widgets).
...
The domain to use as the field's search domain, as a Python expression that evaluates to a[domain](developer/reference/backend/orm.md#reference-orm-domains).
...
QWeb views are standard [QWeb Templates](developer/reference/frontend/qweb.md#reference-qweb) templates inside a view's`arch`. They don't have a specific root element. Because QWeb views don't\
...
* they can be used as frontend templates, in which case[template](developer/reference/backend/data.md#reference-data-template) should be used as a shortcut.
