...
does not build in *classes*<sup>[1](#id6)</sup> although it provides roughly
...
and provides a better API than standard [W3C DOM](http://www.w3.org/TR/DOM-Level-3-Core/)<sup>[2](#dombugs)</sup>, but
...
<a id="howtos-web-client-actions"></a>
...
* <a id='id6'>**[1]**</a> as a separate concept from instances. In many languages classes are full-fledged objects and themselves instance (of metaclasses) but there remains two fairly separate hierarchies between classes and instances
* <a id='dombugs'>**[2]**</a> as well as papering over cross-browser differences, although this has become less necessary over time
