...
* [Quản lý cơ sở dữ liệu](./)
  ...
  * [Các phiên bản](./#editions)
    ...
    * [On-premise](administration/on_premise.md)
      * [Đăng ký cơ sở dữ liệu](administration/on_premise.md#register-a-database)
      * [Sao chép cơ sở dữ liệu](administration/on_premise.md#duplicate-a-database)
      * [Các thông báo lỗi thường gặp và giải pháp](administration/on_premise.md#common-error-messages-and-solutions)
        * [Lỗi đăng ký](administration/on_premise.md#registration-error)
        * [Lỗi quá nhiều người dùng](administration/on_premise.md#too-many-users-error)
        * [Lỗi cơ sở dữ liệu hết hạn](administration/on_premise.md#database-expired-error)
      ...
      * [Testing Odoo](developer/reference/backend/testing.md)
        ...
        * [Integration Testing](developer/reference/backend/testing.md#integration-testing)
          ...
          * [Debugging tips](developer/reference/backend/testing.md#debugging-tips)
            ...
            * [Screenshots and screencasts during browser\_js tests](developer/reference/backend/testing.md#screenshots-and-screencasts-during-browser-js-tests)
...
* [Contributing](contributing.md)
  * [Development](contributing/development.md)
    ...
    * [Environment setup](contributing/development.md#environment-setup)
    * [Make your first contribution](contributing/development.md#make-your-first-contribution)
  * [Documentation](contributing/documentation.md)
    ...
    * [reStructuredText (RST)](contributing/documentation.md#restructuredtext-rst)
    * [Environment setup](contributing/documentation.md#environment-setup)
    * [Contributing to the documentation](contributing/documentation.md#contributing-to-the-documentation)
